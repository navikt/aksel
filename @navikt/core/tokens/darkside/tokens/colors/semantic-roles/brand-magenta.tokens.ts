...
export const brandMagentaSemanticTokenConfig = {
  ...
  text: {
    "brand-magenta": {
      ...
      comment: "Sterk farge for tekst og ikoner for rollen brand magenta. Godkjent på alle bakgrunner unntatt strong.",
    },
    "brand-magenta-subtle": {
      value: "{ax.brand-magenta.800.value}",
      type: "color",
      group: "text.brand-magenta",
      comment: "Standard farge for tekst og ikoner med rollen brand magenta. Godkjent på alle bakgrunner unntatt strong.",
    },
    "brand-magenta-icon": {
      value: "{ax.brand-magenta.600.value}",
      type: "color",
