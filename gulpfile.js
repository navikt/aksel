...
function fixIconFile() {
    ...
    const content = oldContent
        ...
        .replace('height: React.PropTypes.number,', 'height: React.PropTypes.oneOfType([React.PropTypes.number, React.PropTypes.string]),')
        .replace('width: React.PropTypes.number,', 'width: React.PropTypes.oneOfType([React.PropTypes.number, React.PropTypes.string]),');
