...
### Installering:
```
npm install nav-frontend-tabs nav-frontend-js-utils lodash.throttle prop-types react nav-frontend-tabs-style nav-frontend-core nav-frontend-typografi-style --save
```
