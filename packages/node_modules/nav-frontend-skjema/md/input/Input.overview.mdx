...
<Alertstripe type="advarsel">
    Av tilgjengelighetshensyn så <strong>skal</strong> alle inputfelter ha en tilhørende <code className="inline">label</code> (<Lenke href="https://www.w3.org/TR/WCAG21/#labels-or-instructions">WCAG 3.3.2</Lenke>).
</Alertstripe>
...
<Alertstripe type="advarsel">
    Husk å gi Label-komponenten korrekt <code className="inline">for</code>-attributt (som skal ha samme verdi som inputfeltets <code className="inline">id</code>-attributt) slik at disse blir sammenkoblet riktig.
</Alertstripe>
