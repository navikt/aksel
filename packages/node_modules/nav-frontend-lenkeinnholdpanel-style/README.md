# less-module: nav-frontend-lenkeinnholdpanel-style

### Installering:
```
npm install nav-frontend-lenkeinnholdpanel-style
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lenkeinnholdpanel-style
