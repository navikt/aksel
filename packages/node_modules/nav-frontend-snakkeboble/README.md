...
### Installering:
```
npm install nav-frontend-snakkeboble react classnames nav-frontend-snakkeboble-style nav-frontend-paneler nav-frontend-paneler-style nav-frontend-typografi --save
```
