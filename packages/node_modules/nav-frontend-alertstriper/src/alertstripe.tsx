...
const ikonKind = (type: AlertStripeType): icons => {
    const kindMap = {
        ...
        'suksess-sirkel-fyll': type === 'suksess',
        'advarsel-sirkel-fyll': type === 'advarsel',
        'stopp-sirkel-fyll': type === 'stopp'
    };
...
export { default as AlertStripeStoppSolid } from './suksess-solid-alertstripe';
export { default as AlertStripeStopp } from './suksess-alertstripe';
