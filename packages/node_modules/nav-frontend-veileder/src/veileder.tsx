...
import 'nav-frontend-veileder-style/css/index.css';

const cls = (props) => cn('nav-veileder', props.className, {
...
const pilCls = (props) => cn('nav-veileder__snakkeboblePil', {
...
const snakkebobleCls = (props) => cn('nav-veileder__snakkeboble', {
    ...
    render() {
        ...
        return (
            <div className={cls(this.props)} {...domProps}>
                ...
                {tekst && (
                    <div className={snakkebobleCls(this.props)}>
                        {' '}
                        {this.props.tekst}
                    </div>
                )}
