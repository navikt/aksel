...
### Installering:
```
npm install nav-frontend-lenkepanel classnames nav-frontend-lenkepanel-style nav-frontend-chevron-style nav-frontend-core react nav-frontend-typografi nav-frontend-typografi-style prop-types --save
```
