...
### Installering:
```
npm install nav-frontend-hjelpetekst babel-polyfill babel-runtime classnames nav-frontend-core nav-frontend-hjelpetekst-style nav-frontend-ikoner-assets nav-frontend-lukknapp nav-frontend-lukknapp-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
