 ...
 */
class Ekspanderbartpanel extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <EkspanderbartpanelPure {...renderProps} apen={this.state.apen} onClick={this.handleClick} />
        );
    }
}

Ekspanderbartpanel.propTypes = {
    /**
