...
<Example>
    <SkjemaGruppe legend="Kontaktperson" description="Personen som noen kan kontakte">
        <Input label="Fornavn" />
        <Input label="Etternavn" />
    </SkjemaGruppe>
</Example>
...
<Example>
    <SkjemaGruppe feil="Her er det noe feil" errorId={guid()}>
        <Input label="Fornavn" />
        <Input label="Etternavn" />
    </SkjemaGruppe>
</Example>
...
## Felles feilmelding uten propagering av feil til barnekomponenter

Bruk `utenFeilContext`-propen for å bestemme om `feil`-propen til skjermgruppen skal propageres til barnekomponenter.

<Example>
    <SkjemaGruppe feil="Her er det noe feil" errorId={guid()} utenFeilContext>
        <Input label="Fornavn" />
...
```jsx
<SkjemaGruppe feil="Her er det noe feil" utenFeilContext>
    <Input label="Fornavn" />
    <Input label="Etternavn" feil="Feilen er her!"/>
    <Input label="Adresse"  />
</SkjemaGruppe>
