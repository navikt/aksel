...
export const metaPurpleSemanticTokenConfig = {
  ...
  text: {
    "meta-purple": {
      ...
      comment: "Sterk farge for tekst og ikoner for rollen meta purple. Godkjent på alle bakgrunner unntatt strong.",
    },
    "meta-purple-subtle": {
      value: "{ax.meta-purple.800.value}",
      type: "color",
      group: "text.meta-purple",
      comment: "Standard farge for tekst og ikoner med rollen meta purple. Godkjent på alle bakgrunner unntatt strong.",
    },
    "meta-purple-icon": {
      value: "{ax.meta-purple.600.value}",
      type: "color",
