    ...
    render() {
        ...
        return (
            <div className="hjelpetekst__container">
                ...
                >
                    <Anchor className="hjelpetekst__anchor" hover={this.state.hover} focus={this.state.focus} active={this.state.active} />
                </button>
                {Hjelpetekst}
            </div>
        );
...
HjelpetekstBase.defaultProps = {
    tittel: 'Hjelptekst',
    anchor: (props) => <Ikon kind={ props.hover ? 'help-circle_hover' : 'help-circle' } className={props.className} />
};
