...
const componentTitleCls = (beta, style) =>
...
class ComponentGuidelinePage extends React.Component {
  ...
  render() {
    ...
    const style =
      this.props.componentData.manifest.name.indexOf("-style") !== -1;
      ...
      <React.Fragment>
        ...
        >
          <div id="beta-component-modal">
            ...
            <p>
              Beta-komponenter kan inneholde mange bugs, og mangle sentrale
              funksjoner og dokumentasjon. Det er også fare for at disse
              komponentene og deres API vil forandre seg mye mellom hver
              oppdatering.
            </p>
            <br />
            <Knapp
        ...
        <div className="componentGuidelinePage">
          {beta && (
            <Alertstripe type="advarsel">
              ...
              <Lenke href="#" onClick={this.toggleModal}>
                Hva betyr det?
              </Lenke>
            </Alertstripe>
          )}
          <div className={componentTitleCls(beta, style)}>
            <Innholdstittel>{this.props.componentData.name}</Innholdstittel>
            {style && <EtikettInfo>CSS</EtikettInfo>}
          </div>
          {this.props.textData.ingress && (
            <Ingress tag="div" className="intro">
              <this.props.textData.ingress.default />
            </Ingress>
          )}
