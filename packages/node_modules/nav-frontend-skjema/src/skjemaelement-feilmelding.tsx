...
export interface SkjemaelementFeil {
    feilmelding: string | React.ReactNode;
}
...
(SkjemaelementFeilmelding as React.ComponentClass).propTypes = {
  /**
...
(SkjemaelementFeilmelding as React.ComponentClass).defaultProps = {
    feil: undefined
};
