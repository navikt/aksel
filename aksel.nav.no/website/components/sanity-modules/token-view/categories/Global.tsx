...
import { BodyShort, CopyButton, Tabs } from "@navikt/ds-react";
...
export const GlobalView = ({ cat }: { cat: string }) => {
  ...
  return (
    <Tabs size="small" defaultValue="tokens">
      <Tabs.List>
        <Tabs.Tab value="tokens" label="Tokens" />
        <Tabs.Tab value="css" label="CSS" />
        <Tabs.Tab value="scss" label="SCSS" />
        <Tabs.Tab value="js" label="JS" />
      </Tabs.List>
      <Tabs.Panel value="css">TODO</Tabs.Panel>
      <Tabs.Panel value="scss">TODO</Tabs.Panel>
      <Tabs.Panel value="js">TODO</Tabs.Panel>
