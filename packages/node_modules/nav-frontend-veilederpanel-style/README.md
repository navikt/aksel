# less-module: nav-frontend-veilederpanel-style
...
```
npm install nav-frontend-core nav-frontend-paneler-style nav-frontend-typografi-style nav-frontend-veilederpanel-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-veilederpanel-style
