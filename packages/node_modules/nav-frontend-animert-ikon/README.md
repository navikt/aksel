# react-module: nav-frontend-animert-ikon

Ella som blunker. Animert veilder. Animasjon produsert i Adobe After Effects, eksportert med Bodymovin plugin og avspilt med Lotti.

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-animert-ikon babel-polyfill babel-runtime react react-lottie --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-animert-ikon
<!-- AUTO-GENERATED-CONTENT:END *-->