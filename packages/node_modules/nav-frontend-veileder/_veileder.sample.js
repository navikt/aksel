...
export default generateSample({
    ...
    attrs: {
        says,
        color: '#c1b5d0',
        chatBubbleStyles: { width: 200 }
    },
    children: <Aleksander />,
    modifierNames: ['transparent', 'nomask']
});
...
const arrowStyles = {
    'borderRight': '20px solid rgb(92, 67, 120)',
    'right': 'auto',
    'left': 35
};
...
export default generateSample({
    ...
    attrs: {
        ...
        chatBubbleArrowStyles: arrowStyles
    },
    children: <Aleksander />,
    modifierNames: ['transparent', 'nomask']
});
