...
class Veileder extends React.Component<VeilederProps> {
    ...
    renderSnakkeboble = () => {
        return (
            <div className="nav-veileder__snakkeboble">
                {this.props.tekst}
                <i className="nav-veileder__snakkeboblePil"/>
            </div>
        );
    }
...
export const VeilederPropsShape = PT.shape({
    /**
     * Custom SVG-element som illustrerer en figur, f.eks. en av disse:
     * https://app.zeplin.io/project/59831e455850985791bdeb4d/screen/5a7c1fcc36781f9423ab6a0e
     */
...
(Veileder as any).propTypes = VeilederPropsShape;
