    ...
    <>
      ...
      >
        ...
        <main
          tabIndex={-1}
          id="hovedinnhold"
          className="bg-component-background-alternate relative flex justify-center focus:outline-none"
        >
          <div className="min-h-screen-header flex w-full flex-col items-center">
            <div className="bg-canvas-background-light relative flex w-full justify-center">
            ...
            <div className="bg-component-background-alternate flex w-full max-w-screen-2xl flex-col flex-wrap">
