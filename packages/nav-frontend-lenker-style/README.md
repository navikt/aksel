# less-module: nav-frontend-lenker-style
...
```
npm install nav-frontend-core nav-frontend-lenker-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lenker-style
