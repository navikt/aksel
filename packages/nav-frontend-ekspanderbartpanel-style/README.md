# less-module: nav-frontend-ekspanderbartpanel-style
...
```
npm install nav-frontend-chevron-style nav-frontend-core nav-frontend-ekspanderbartpanel-style nav-frontend-paneler-style nav-frontend-typografi-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-ekspanderbartpanel-style
