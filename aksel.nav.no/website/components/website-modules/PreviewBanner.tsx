...
function PreviewBanner(): JSX.Element {
  ...
  if (data === null) {
    return (
      <>
        ...
        <div className="text-text-inverted fixed top-0 z-[9999] grid w-full justify-center bg-gray-900 px-4 py-4 text-center font-semibold no-underline">
          <BodyShort spacing>
  ...
  return (
    <a
      href={`/api/exit-preview?slug=${asPath}`}
      className="text-text-inverted focus-visible:shadow-focus-inverted fixed top-2 left-0 z-[9999] w-80 -translate-x-24 translate-y-6 -rotate-45 bg-gray-900 p-4 text-center font-semibold no-underline hover:bg-gray-700 focus:outline-none"
    >
