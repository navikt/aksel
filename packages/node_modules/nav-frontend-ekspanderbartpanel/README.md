...
### Installering:
```
npm install classnames nav-frontend-chevron-style nav-frontend-core nav-frontend-ekspanderbartpanel nav-frontend-ekspanderbartpanel-style nav-frontend-paneler-style nav-frontend-typografi-style react react-collapse --save
```
