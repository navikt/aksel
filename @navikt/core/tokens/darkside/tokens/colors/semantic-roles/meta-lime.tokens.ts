...
export const metaLimeSemanticTokenConfig = {
  ...
  text: {
    "meta-lime": {
      ...
      comment: "Sterk farge for tekst og ikoner for rollen meta lime. Godkjent på alle bakgrunner unntatt strong.",
    },
    "meta-lime-subtle": {
      value: "{ax.meta-lime.800.value}",
      type: "color",
      group: "text.meta-lime",
      comment: "Standard farge for tekst og ikoner med rollen meta lime. Godkjent på alle bakgrunner unntatt strong.",
    },
    "meta-lime-icon": {
      value: "{ax.meta-lime.600.value}",
      type: "color",
