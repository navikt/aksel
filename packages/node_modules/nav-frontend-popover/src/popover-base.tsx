...
export enum PopoverOrientering {
    ...
    OverHøyre = 'over-høyre',
    Under = 'under',
    UnderVenstre = 'under-venstre',
    UnderHøyre = 'under-høyre',
    Venstre = 'venstre',
    Høyre = 'høyre'
}
...
export interface PopoverBaseProps extends React.HTMLAttributes<HTMLDivElement> {
     ...
     * Mulige verdier: `over`, `over-venstre`, `over-høyre`, `under`, `under-venstre`, `under-høyre`, `venstre`,
     * `høyre`
     */
...
class PopoverBase extends React.PureComponent<PopoverBaseProps> {
    ...
    render() {
        ...
        const stiler = { transform: `translate3d(${posisjon!.left}px, ${posisjon!.top}px, 0)` };

        let pilStiler;
        if ([PopoverOrientering.Høyre, PopoverOrientering.Venstre].indexOf(this.props.orientering!) === -1) {
...
export default React.forwardRef<PopoverBase, PopoverBaseProps>(
    (props, ref: React.RefObject<HTMLDivElement>) => <PopoverBase innerRef={ref} {...props} />
);
