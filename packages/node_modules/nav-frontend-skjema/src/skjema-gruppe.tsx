...
export interface SkjemaGruppeProps {
     ...
     */
    propagereFeilTilChildren?: boolean;
}
    ...
    render() {
        ...
        const content = (
            <React.Fragment>
                ...
                { (propagereFeilTilChildren) ? children : childrenWithContext }
...
(SkjemaGruppe as React.ComponentClass).propTypes = {
     ...
     */
    propagereFeilTilChildren: PT.bool
};
...
(SkjemaGruppe as React.ComponentClass).defaultProps = {
    ...
    feilmeldingId: guid(),
    tag: 'fieldset',
    propagereFeilTilChildren: undefined
};
