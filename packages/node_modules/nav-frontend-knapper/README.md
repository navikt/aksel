...
### Installering:
```
npm install nav-frontend-knapper classnames nav-frontend-js-utils lodash.throttle prop-types react nav-frontend-knapper-style nav-frontend-core nav-frontend-typografi-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-knapper
<!-- AUTO-GENERATED-CONTENT:END *-->