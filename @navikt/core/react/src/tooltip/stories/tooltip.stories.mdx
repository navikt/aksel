...
import { Tooltip, Button, BodyLong, Link } from "../..";
...
<Tooltip placement="auto" content="Tooltip text">
  <BodyLong>
    Adipisicing et esse qui tempor eiusmod esse veniam excepteur nulla ut.
    <abbr title="innhold"> Short form </abbr>Velit nostrud cillum sint deserunt in.
  </BodyLong>
</Tooltip>
```
...
<Canvas>
  <BodyLong>
    Ut pariatur{" "}
    <Tooltip arrow={false} content="Tooltip text">
      <Link href="#">Lenketekst her</Link>
    </Tooltip>{" "}
    Velit nostrud
  </BodyLong>
</Canvas>
