...
class ToggleGruppe extends React.Component<ToggleGruppeProps, ToggleGruppeState> {
    ...
    componentWillReceiveProps(nextProps) {
        const emptyArray: number[] = [];
        if (typeof this.props.defaultPressed === 'number' || typeof nextProps.defaultPressed === 'number') {
            if (this.props.defaultPressed !== nextProps.defaultPressed) {
                this.setState({ pressedIndexes: emptyArray.concat(nextProps.defaultPressed) });
            }
        }
        if (!equalArrays(this.props.defaultPressed, nextProps.defaultPressed)) {
            this.setState({ pressedIndexes: emptyArray.concat(nextProps.defaultPressed) });
        }
    }
