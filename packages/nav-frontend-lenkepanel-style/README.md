# less-module: nav-frontend-lenkepanel-style
...
```
npm install nav-frontend-chevron-style nav-frontend-core nav-frontend-lenkepanel-style nav-frontend-paneler-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lenkepanel-style
