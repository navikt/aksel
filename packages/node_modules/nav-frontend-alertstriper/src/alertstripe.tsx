...
const ikonKind = (type, solid): icons => {
    const kindMap = {
...
class AlertStripe extends React.Component<AlertStripeBaseProps> {
    render() {
        ...
        const role = (type === 'advarsel') ? 'alert' : undefined;

        return (
            <div className={cls(type, solid, className)} {...props} aria-live={ariaLive} role={role}>
