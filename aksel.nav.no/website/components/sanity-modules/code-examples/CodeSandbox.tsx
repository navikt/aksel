...
export const CodeSandbox = ({ code }: { code: string }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="focus-visible:shadow-focus-inset flex items-center justify-center gap-2 rounded-sm px-3 py-2 hover:bg-gray-100 focus:outline-none active:bg-gray-200"
      >
        <Edit aria-hidden />
        CodeSandbox
      </button>
