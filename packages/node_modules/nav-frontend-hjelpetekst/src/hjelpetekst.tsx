...
class HjelpetekstBase extends React.Component<HjelpetekstProps, State> {
    ...
    renderLabel() {
        return <Normaltekst>{this.props.labelTekst}</Normaltekst>;
    }
    ...
    render() {
        ...
        const apneKnappCls = classNames('hjelpetekst__apneknapp', {
            'hjelpetekst__apneknapp--med-beskrivelse': this.props.labelTekst
        });
        ...
        return (
            <div className="hjelpetekst">
                ...
                >
                    ...
                    {this.props.labelTekst && this.renderLabel()}
                    <Anchor
                ...
                {this.state.erSynlig && this.renderContent()}
            </div>
        );
    }
}
