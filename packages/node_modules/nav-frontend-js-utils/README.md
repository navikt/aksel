# react-module: nav-frontend-js-utils
...
```
npm install lodash.throttle nav-frontend-js-utils prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-js-utils
