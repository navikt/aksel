...
const newTokensWithoutRegex: TokensWithTailwindTag = {
  ...
  "border-radius-xlarge": generateRoundedTwTags("12"),
  "border-radius-large": generateRoundedTwTags("8"),
  "border-radius-medium": generateRoundedTwTags("4"),
  "border-radius-small": generateRoundedTwTags("2"),
  "space-128": null,
  "space-96": null,
  "space-80": null,
  "space-72": null,
