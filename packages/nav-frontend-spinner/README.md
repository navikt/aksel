# react-module: nav-frontend-spinner
...
```
npm install classnames nav-frontend-ikoner-assets nav-frontend-spinner nav-frontend-spinner-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-spinner
