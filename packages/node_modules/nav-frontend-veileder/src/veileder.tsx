...
const cls = (props) => cn('nav-veileder', {
    'nav-veileder--warning': props.type === 'advarsel',
    'nav-veileder--error': props.type === 'feilmelding',
    'nav-veileder--success': props.type === 'suksess'
});

const frameCls = (props) => cn('nav-veileder__frame', {
    'nav-veileder__frame--center': props.sentrer,
    'nav-veileder__frame--transparent': props.transparent,
    'nav-veileder__frame--nomask': props.utenMaske
});
...
class NavVeileder extends React.Component<NavVeilederProps> { // eslint-disable-line react/prefer-stateless-function
    ...
    getChatBubble(veilederBredde) {
        if (typeof this.props.sier !== 'undefined' && this.props.sier) {
            return <NavVeilederSnakkeboble sier={this.props.sier} offset={veilederBredde} />
        }
    }
