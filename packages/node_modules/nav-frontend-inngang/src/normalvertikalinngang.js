...
class NormalVertikalInngang extends Component { // eslint-disable-line react/prefer-stateless-function
    ...
    renderNormalVertikalInngangMedIkon(ikon, tittel, tekst) {
        return (
            <div className="inngang__normalvertikalinngang--medikon">
    ...
    renderNormalVertikalInngangMedLink(tittel, tekst, link) {
        return (
            <div className="inngang__normalvertikalinngang--medlink">
                { this.renderTekstInnhold(tittel, tekst) }
                <a className="lenke" href={link}>Les mer</a>
            </div>
        );
    }
    ...
    render() {
        ...
        return (
            <div {... props} className="inngang inngang__normalvertikalinngang" tabIndex={0}>
                { renderedContent }
            </div>
        );
    }
