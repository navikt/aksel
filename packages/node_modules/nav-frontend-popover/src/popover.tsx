...
class Popover extends React.Component<PopoverProps, PopoverState> {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        } else if (!nextProps.apen || !nextProps.ankerEl) {
            this.listenToScrollOn.removeEventListener('scroll', this.handleResize);
        }
    }
    ...
    calculatePosition(ankerEl) {
        ...
        switch (this.props.orientering) {
            case 'over-venstre':
                left = ankerOffset.x + ankerOffset.width - popoverOffset.width + 8;
                top = ankerOffset.y - avstandTilAnker - popoverOffset.height;
                break;
            case 'over-høyre':
                left = ankerOffset.x - 8;
                top = ankerOffset.y - avstandTilAnker - popoverOffset.height;
                break;
            case 'venstre':
        ...
        // console.log(left, popoverOffset.width, viewPortDimensions.w);
        ...
        const pilLeft = ankerOffset.x + (ankerOffset.width / 2) - left;
