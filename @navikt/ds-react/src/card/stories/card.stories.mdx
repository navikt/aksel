...
Denne funksjonaliteten fungerer for både Card, MiniCard og MicroCard

## Illustrasjoner

Illustrasjonene som skal brukes her er predefinerte "pictograms" som ligger på figma.
For å sikre riktige farger når cards er `:active` må man legge til en klasse på elementet/elementene som
lager bakgrunnen i svg-en.

```svg
const illustrationPictogram =
...
I eksemplet her ser man at linjen `<path className="navds-card__illustration-bg".... `. Når card er active nå
så vil dette elementet få riktig styling.
