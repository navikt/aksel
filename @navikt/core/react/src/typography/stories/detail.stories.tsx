...
export const ColorRole: Story = {
  render: () => (
    <VStack gap="2">
      ...
      <Detail data-color-role="brand-magenta">{lorem}</Detail>
      <Detail data-color-role="brand-magenta" textColor="default">
        {lorem}
      </Detail>
      <Detail data-color-role="brand-magenta" textColor="subtle">
        {lorem}
      </Detail>
    </VStack>
  ),
