...
### Installering:
```
npm install nav-frontend-stegindikator classnames nav-frontend-js-utils lodash.throttle prop-types react nav-frontend-stegindikator-style nav-frontend-core --save
```
