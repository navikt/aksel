# less-module: nav-frontend-avatar-style
...
```
npm install nav-frontend-core nav-frontend-veileder-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-veileder-style
