...
import 'nav-frontend-typografi-style/css/index.css';
...
export const typeConfigMap = {
    ...
    feilmelding: { defaultTag: 'p', cls: (...args) => classNames('typo-feilmelding', ...args) },
    ...
    undertekstBold: { defaultTag: 'p', cls: (...args) => classNames('typo-undertekst-bold', ...args) },
...
class TypografiBase extends React.Component<TypografiBaseProps> {
    render() {
        const {
            type, tag, className, children, ...props
        } = this.props;
