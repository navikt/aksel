...
const cls = (type, solid, className) => classNames('alertstripe', className, {
    ...
    'alertstripe--info': type === AlertStripeType.info,
    'alertstripe--suksess': type === AlertStripeType.suksess,
    'alertstripe--advarsel': type === AlertStripeType.advarsel,
    'alertstripe--feil': type === AlertStripeType.feil
});

const ikonKind = (type: AlertStripeType): icons => {
    const kindMap = {
        'info-sirkel-fyll': type === AlertStripeType.info,
        'ok-sirkel-fyll': type === AlertStripeType.suksess,
        'advarsel-sirkel-fyll': type === AlertStripeType.advarsel,
        'feil-sirkel-fyll': type === AlertStripeType.feil
    };
...
class AlertStripe extends React.Component<AlertStripeBaseProps> {
    render() {
        ...
        const ariaLive = (type === AlertStripeType.advarsel || type === AlertStripeType.feil) ?
            'assertive' :
            undefined;
...
export { default as AlertStripeFeilSolid } from './feil-solid-alertstripe';
