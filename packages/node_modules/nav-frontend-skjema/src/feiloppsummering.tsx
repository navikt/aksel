...
import 'nav-frontend-skjema-style/css/index.css';

export interface FeiloppsummeringProps extends React.HTMLAttributes<HTMLDivElement> {
    /**
...
class Feiloppsummering extends React.Component<FeiloppsummeringProps> {
    render() {
        const {
            children, className, innerRef, tittel, feil, customFeilRender, ...rest
        } = this.props;
        return (
            <div
                ref={innerRef}
                ...
                {...rest}
            >
                {(typeof tittel === 'string') ? <Undertittel>{tittel}</Undertittel> : tittel}
