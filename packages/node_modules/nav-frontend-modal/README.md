...
### Installering:
```
npm install nav-frontend-modal classnames nav-frontend-core nav-frontend-lukknapp nav-frontend-lukknapp-style nav-frontend-modal-style nav-frontend-paneler-style prop-types react react-modal --save
```
