# less-module: nav-frontend-chevron-style
...
```
npm install nav-frontend-chevron-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-chevron-style
