...
class Textarea extends Component {
    ...
    handleChange = (e) => {
        e.target.style.height = `${36}px`;
        e.target.style.height = `${this.tekstomrade.scrollHeight + 30}px`;
    ...
    render() {
        const { label, maxLength, textareaClass, id, name } = this.props;

        const textareaId = id || name || guid();
        const cls = (className) => classNames(className, 'skjemaelement__textarea textareaMedMeta');
        ...
        return (
            <div className="skjemaelement">
                ...
                <textarea
                    ...
                    maxLength={maxLength}
                />
                <p className="textareaMedMeta__teller">
                    <span>{maxLength - this.state.antall} tegn igjen</span>
                </p>
            </div>
        );
    }
