...
export const successSemanticTokenConfig = {
  bg: {
    ...
    "success-moderate": {
      ...
      type: "color",
      group: "background.success",
      comment: "En medium-svak bakgrunnsfarge som brukes til dekor. Om den brukes på meningsbærende elementer må den kombineres med en godkjent border (f.eks. alert success).",
    },
    "success-moderateA": {
  ...
  text: {
    success: {
      ...
      type: "color",
      group: "text.success",
      comment: "Sterk farge for tekst og ikoner for rollen success. Godkjent på alle bakgrunner unntatt strong.",
    },
    "success-subtle": {
      value: "{ax.success.800.value}",
      type: "color",
      group: "text.success",
      comment: "Standard farge for tekst og ikoner med rollen success. Godkjent på alle bakgrunner unntatt strong.",
    },
    "success-icon": {
      value: "{ax.success.600.value}",
      type: "color",
