...
/**
 * Controlled tekstområde, dvs at verdi i tekstområdet håndteres via props.
 * Tekstområdet er selvekspanderende og har teller.
 */
class TextareaControlled extends Component {
    ...
    render() {
        ...
        const antallTegn = this.state.antall;
