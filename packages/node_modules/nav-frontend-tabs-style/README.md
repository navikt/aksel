# less-module: nav-frontend-tabs-style
...
```
npm install nav-frontend-core nav-frontend-tabs-style nav-frontend-typografi-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-tabs-style
