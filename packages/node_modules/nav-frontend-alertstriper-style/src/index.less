...
.alertstripe {
  ...
  &--info {
    border: 2px solid @navLysBla;
  }

  &--suksess {
    border: 2px solid @navGronn;
  }

  &--advarsel {
    border: 2px solid @navOransje;
  }
  ...
  &--solid {
    ...
    &.alertstripe--advarsel {
      background-color: @navOransjeLighten80;
    }

    &.alertstripe--stopp {
      background-color: @navRodLighten60;
    }
  }
  ...
  &__ikon {
    ...
    display: flex;
    top: 1rem;
    flex-shrink: 0; // Forhindre krymping av ikon i IE 11
  }

  &.alertstripe--solid {
    .alertstripe__ikon {
      border-right: 1px solid @navGra60;
    }
  }
  &:not(.alertstripe--solid) {
    .alertstripe__ikon {
