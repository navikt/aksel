...
const Footer = ({ variant = "ds" }: { variant: "ds" | "aksel" }) => {
  return (
    <footer
      ...
      data-theme="dark"
      className={cl(
        "algolia-ignore-index text-text-inverted relative flex w-full justify-center  px-4",
        {
            ...
            <BodyShort as="ul" className="mt-5 grid gap-2">
              <li>
                <NextLink href="/artikkel/om-aksel" passHref>
                  <Link className="text-text-inverted focus:text-text focus:shadow-focus focus:bg-blue-200 focus:shadow-blue-200">
                    Om Aksel
                  </Link>
                </NextLink>
              </li>
              ...
              {variant === "aksel" && (
                <li>
                  <Link
                    className="text-text-inverted focus:text-text focus:shadow-focus focus:bg-blue-200 focus:shadow-blue-200"
        ...
        <div className="grid xl:grid-cols-3 xl:gap-6">
          ...
          <div className="hidden self-end xl:block">
            ...
            <NextLink href="/side/personvernerklaering" passHref>
              <a className="focus:bg-focus-inverted focus:text-text focus:ring-focus-inverted outline-none hover:underline focus:no-underline focus:ring">
