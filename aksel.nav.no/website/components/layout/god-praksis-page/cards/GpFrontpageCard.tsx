  ...
  return (
    <li className="flex items-center gap-2 px-2 py-4 sm:gap-4 sm:px-6">
      ...
      <NextLink
        href={href}
        passHref
        className="navds-heading--small navds-link navds-heading flex-wrap break-all text-deepblue-700 no-underline hover:underline focus:text-text-on-inverted focus:outline-none"
        onClick={() =>
          umamiTrack("navigere", {
