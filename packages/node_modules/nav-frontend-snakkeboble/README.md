...
### Installering:
```
npm install nav-frontend-snakkeboble classnames nav-frontend-core nav-frontend-paneler nav-frontend-paneler-style nav-frontend-snakkeboble-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
