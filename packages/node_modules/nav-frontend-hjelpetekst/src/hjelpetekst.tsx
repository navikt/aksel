...
export interface HjelpetekstProps {
    ...
    className?: string;
    /**
     * Tekstbeskrivelse som vises ved siden av hjelpe-ikonet
     */
    tekstBeskrivelse?: string;
    /**
...
export interface State {
    ...
    focus: boolean;
    active: boolean;
    variant: 'auto' | 'over' | 'under' | 'venstre' | 'midt' | 'hoyre' | 'under-venstre' | 'under-hoyre';
}

class HjelpetekstBase extends React.Component<HjelpetekstProps, State> {
    ...
    componentWillUpdate(nextProps: HjelpetekstProps, nextState: State) {
    ...
    render() {
        ...
        const tekstBeskrivelse = this.props.tekstBeskrivelse;
        const TekstBeskrivelse = tekstBeskrivelse ? <Normaltekst>{tekstBeskrivelse}</Normaltekst> : null;
        const TekstBeskrivelseClass = tekstBeskrivelse ? 'hjelpetekst__apneknapp--med-beskrivelse' : '';
        ...
        return (
            <div className="hjelpetekst">
                <button
                    ...
                    className={`hjelpetekst__apneknapp ${TekstBeskrivelseClass}`}
                    onClick={this.toggleSynlighet}
...
export { default as HjelpetekstUnderHoyre } from './hjelpetekst-under-hoyre';
export { default as HjelpetekstUnderVenstre } from './hjelpetekst-under-venstre';
