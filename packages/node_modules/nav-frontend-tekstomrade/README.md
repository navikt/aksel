# react-module: nav-frontend-tekstomrade
...
```
npm install classnames nav-frontend-core nav-frontend-lenker nav-frontend-lenker-style nav-frontend-tekstomrade nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
