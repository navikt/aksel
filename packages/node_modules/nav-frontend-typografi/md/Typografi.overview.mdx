...
``` less
@import (reference) '~nav-frontend-typografi-style/less/src/index';
```
 i ønsket less fil og da legge til `app` i `className` på elementet som pakker in prosjektet ditt.
