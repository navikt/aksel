...
import SkjemaelementFeilmelding, { SkjemaelementFeil, skjemaelementFeilmeldingShape } from './skjemaelement-feilmelding';
...
export interface NavFrontendInputProps extends React.HTMLAttributes<HTMLInputElement> {
