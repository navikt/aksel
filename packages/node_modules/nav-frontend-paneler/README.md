...
### Installering:
```
npm install nav-frontend-paneler classnames nav-frontend-core nav-frontend-paneler-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
