...
export const neutralSemanticTokenConfig = {
  bg: {
    ...
    "neutral-moderate-hoverA": {
      ...
      type: "color",
      group: "background.neutral",
      comment: "En medium-svak bakgrunnsfarge som brukes til hover-state på meningsbærende elementer (f.eks. button neutral secondary hover). Må kombineres med en godkjent border. Er delvis gjennomsiktig.",
    },
    ...
    "neutral-moderate-pressedA": {
      ...
      type: "color",
      group: "background.neutral",
      comment: "En medium-svak bakgrunnsfarge som brukes til active/selected-state på meningsbærende elementer (f.eks. button neutral secondary active). Må kombineres med en godkjent border. Er delvis gjennomsiktig.",
    },
    "neutral-strong": {
      value: "{ax.neutral.700.value}",
      type: "color",
      group: "background.neutral",
      comment: "En sterk bakgrunnsfarge som brukes på meningsbærende elementer (f.eks. button neutral primary).",
    },
    "neutral-strong-hover": {
      value: "{ax.neutral.800.value}",
      type: "color",
      group: "background.neutral",
      comment: "En sterk bakgrunnsfarge som brukes til hover-state på meningsbærende elementer (f.eks. button neutral primary hover).",
    },
    "neutral-strong-pressed": {
      value: "{ax.neutral.900.value}",
      type: "color",
      group: "background.neutral",
      comment: "En sterk bakgrunnsfarge som brukes til active/selected-state på meningsbærende elementer (f.eks. button neutral primary active).",
    },
  },
  text: {
    neutral: {
      ...
      type: "color",
      group: "text.neutral",
      comment: "Standard farge for tekst og ikoner med rollen neutral. Godkjent på alle bakgrunner unntatt strong.",
    },
    "neutral-subtle": {
      value: "{ax.neutral.900.value}",
      type: "color",
      group: "text.neutral",
      comment: "En nedtonet farge for tekst og ikoner med rollen neutral. Godkjent på alle bakgrunner unntatt strong.",
    },
    "neutral-icon": {
    ...
    "neutral-contrast": {
      ...
      type: "color",
      group: "text.neutral",
      comment: "En farge som brukes på tekst og ikoner som plasseres oppå bakgrunnen strong (f.eks. button neutral primary).",
    },
  },
  border: {
    neutral: {
