...
export default class Icon extends Component {
  ...
  getIcon(kind) {
    ...
    switch (kind) {
      ...
      case ('arbeidsgiver'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 26 26" ><title>Arbeidsgiver</title><g stroke="#3E3832" strokeWidth="1.046" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round"><path d="M13 25H1V10.6h12zM11 4.84H4v5.76h7zM7 3.88V1M25 25h-9V6.76h9zM18 8.68h5M18 10.6h5M18 12.52h5M18 14.44h5M18 16.36h5M18 18.28h5M18 20.2h5M4 13.48h7M4 16.36h7M4 19.24h7M6 6.76h3M6 8.68h3"/><path d="M8 22.12H6v1.92h2zM22 22.12h-2v1.92h2z"/></g></svg>);
