# react-module: nav-frontend-inngang

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-inngang classnames nav-frontend-chevron nav-frontend-chevron-style nav-frontend-core nav-frontend-ikoner-assets nav-frontend-inngang-style nav-frontend-lenker-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-inngang
<!-- AUTO-GENERATED-CONTENT:END *-->