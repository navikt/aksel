...
import { Label, SkjemaGruppeFeilContext, SkjemaGruppeFeilContextProps } from './'
import 'nav-frontend-skjema-style';

const cls = (className) => classNames('skjemaelement', className);
const inputClass = (width, className, harFeil, mini) => classNames(
...
class Input extends React.Component<InputProps> {
    render() {
        const { label, bredde, feil, id, name, inputRef, className, inputClassName, mini, ...other } = this.props;
                ...
                {(context: SkjemaGruppeFeilContextProps) => {
                    ...
                    return (
                        <div className={cls(className)}>
                            ...
                            <input
                                type="text"
                                className={inputClass(bredde, inputClassName, feilmelding, mini)}
                                id={inputId}
                                name={name}
