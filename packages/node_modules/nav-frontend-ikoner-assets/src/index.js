...
export default class Icon extends Component {
  ...
  getIcon(kind) {
    ...
    switch (kind) {
      ...
      case ('help-circle'): return (<svg {...props} height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 18.22 18.22"><path fill="#fff" d="M9.11,1a8.11,8.11,0,1,0,8.11,8.11h0A8.12,8.12,0,0,0,9.11,1Zm0,13.7a.89.89,0,1,1,.89-.9.89.89,0,0,1-.89.9ZM9.61,9v1.89a.5.5,0,0,1-1,0V8.5a.5.5,0,0,1,.5-.5A1.85,1.85,0,1,0,7.26,6.15h0a.5.5,0,0,1-1,0A2.85,2.85,0,1,1,9.61,9Z"/><path fill="#3e3832" d="M9.11,0a9.11,9.11,0,1,0,9.11,9.11h0A9.12,9.12,0,0,0,9.11,0Zm0,17.22a8.11,8.11,0,1,1,8.11-8.11h0A8.12,8.12,0,0,1,9.11,17.22Z"/><path fill="#3e3832" d="M9.11,3.3A2.85,2.85,0,0,0,6.26,6.15a.5.5,0,0,0,1,0A1.85,1.85,0,1,1,9.11,8h0a.5.5,0,0,0-.5.5v2.35a.5.5,0,0,0,1,0V9a2.85,2.85,0,0,0,2.27-3.33A2.9,2.9,0,0,0,9.11,3.3Z"/><circle fill="#3e3832" cx="9.11" cy="13.8" r="0.89"/></svg>);
      case ('help-circle_hover'): return (<svg {...props} height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 18.22 18.22"><path fill="#2868b3" d="M9.11,0a9.11,9.11,0,1,0,9.11,9.11h0A9.12,9.12,0,0,0,9.11,0Z"/><circle fill="#fff" cx="9.11" cy="13.8" r="0.89"/><path fill="#fff" d="M9.11,3.3A2.85,2.85,0,0,0,6.26,6.15a.5.5,0,1,0,1,0A1.85,1.85,0,1,1,9.11,8h0a.5.5,0,0,0-.5.5v2.35a.5.5,0,0,0,1,0V9a2.85,2.85,0,0,0,2.27-3.33A2.9,2.9,0,0,0,9.11,3.3Z"/></svg>);
