...
Typisk er det elementet som åpner komponenten som bør bli komponentens anker (som i eksempelet med knappen nedenfor). Popover-komponenten vil da posisjonere seg selv i forhold til dette anker-
elementet.
...
<Example>
    <PopoverBase apen style={{position:'relative'}}>
