...
<Alertstripe type="advarsel">
    ...
    knappene brukes <strong>unntaksvis ved klart behov</strong>.
</Alertstripe>
...
Bruk `kompakt={true}` for å redusere høyre-/venstre-padding på knappene.
...
<Example>
    <Knapp kompakt={true}><Cog /><span>Knapp</span></Knapp><br/><br/>
    <Knapp kompakt={true}><Cog /><span className="sr-only">Knapp</span></Knapp>
</Example>
