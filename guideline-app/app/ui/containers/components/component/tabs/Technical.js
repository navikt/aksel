...
class Technical extends React.Component {
  constructor(props) {
    ...
    this.installInstructions = [
      ...
      `npm install ${this.props.componentData.dependencies
        .filter(
    ...
    <div className="install-doc">
      <Systemtittel id="install">
        ...
        <Flatknapp
          ...
          onClick={(e) =>
            this.copyContent(e, this.installInstructions[this.state.activeTab])
          }
          kompakt
        >
          <CopyIcon />
      ...
      <Tabs tabs={this.tabs} onChange={this.toggleInstallInstructions} />
      <Panel border>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="dependencies">
                  {Object.keys(
                    this.props.componentData.manifest.peerDependencies
                  ).map((dep) => [
                    <Lenke
                      key={dep}
        ...
        <section className="section full">
          {this.props.componentData.packageModules && (
            <ModuleBrowser
              ...
              package={this.props.componentData.manifest}
            />
          )}
        </section>
      </React.Fragment>
