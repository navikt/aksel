...
<Alertstripe type="advarsel">Vær obs på at det ikke finnes noe <InlineCode>disabled</InlineCode>-attributt for lenker. For å "disable" en lenke må du i stedet fjerne <InlineCode>href</InlineCode>-attributtet.</Alertstripe>
