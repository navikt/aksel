# less-module: nav-frontend-typografi-style

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-typografi-style  --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-typografi-style
<!-- AUTO-GENERATED-CONTENT:END *-->

## Font License
The Source Sans Pro font files in `assets/` are a subset of
