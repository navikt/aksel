...
class Textarea extends Component {
    ...
    renderTextareaElement(textareaRef, textareaClass, feil, textareaId, disabled, other) {
        return (
            <textarea
                ref={(textarea) => {
    ...
    render() {
        const { disabled, label, maxLength, textareaClass, id, name, feil, tellerTekst, textareaRef, ...other } =
            this.props;
        const textareaId = id || name || guid();
        const antallTegn = other.value.length;
        const textareaEl = this.renderTextareaElement(textareaRef, textareaClass, feil, textareaId, disabled, other);
