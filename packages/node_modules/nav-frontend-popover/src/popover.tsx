...
import {
    EventThrottler, keyCodes, getViewportDimensions, getScrollParents
...
class Popover extends React.Component<PopoverProps, PopoverState> {
    ...
    handleClick = (e) => {
        if (this.state.apen && !ReactDOM.findDOMNode(this.props.ankerEl).contains(e.target)) {
    ...
    render() {
        const {
            children, ankerEl, onRequestClose, avstandTilAnker, autoFokus, ...rest
        } = this.props;
