...
### Installering:
```
npm install classnames lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-paneler nav-frontend-paneler-style nav-frontend-tabs nav-frontend-tabs-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
