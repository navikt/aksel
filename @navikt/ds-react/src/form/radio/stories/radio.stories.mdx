...
Radioer har default 44px høy klikkflate. Med size="s" blir denne til 24px slik som før

```jsx
<RadioGroup legend="Mollit eiusmod" error="Boks nr 2 må være valgt" size="s">
  <Radio value="Apple">Apple</Radio>
  <Radio value="Orange">Orange</Radio>
  <Radio value="Melon">Melon</Radio>
</RadioGroup>
