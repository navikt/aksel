...
export const typeConfigMap = {
    ...
    innholdstittel: { defaultTag: 'h2', cls: (...args) => classNames('typo-innholdstittel', ...args) },
    systemtittel: { defaultTag: 'h3', cls: (...args) => classNames('typo-systemtittel', ...args) },
...
export const Systemtittel = (props) => <TypografiBase type="systemtittel" {...props} />;
