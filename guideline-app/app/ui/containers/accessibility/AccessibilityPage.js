    ...
    <div className="accessibilityPage">
        ...
        <div className="section">
            ...
            <ol>
                ...
                <li>
                    Design en meningsfullt rekkefølge – hvordan presenteres ting når man slår av CSSen eller skjermene
                    er mindre?
                </li>
                <li>Husk at ikke alle kan bruke alle sanser</li>
                <ul>
                    <li>
                        Ha tekstalternativer til bilder, grafer, kart, video,… Hvis det bli lengre tekster, ikke skjul
                        dem i koden, men la dem være synlig for alle
                    </li>
                    <li>
                        Fargeblinde kan misforstå hvis informasjon bare baserer seg på farge, som streker i grafer o.l.
                    </li>
                    <li>
                        Unngå formuleringer som forutsetter at du kan se
                        oppsettet på skjermen – som «bildet til høyre» e.l.
                    </li>
                ...
                <ul>
                    <li>
                        Sørg for at brukeren kan navigere på flere måter (meny, søk, a-å-lenker, lenker mellom alle
                        sider på nettstedet)
                    </li>
                ...
                <li>
                    Vær konsekvent. Bruk de samme designelementene for å oppnå samme på på tvers av sider og løsninger.
                </li>
                <li>
                    Husk å lage gode feilmeldinger. De skal være enkle å forstå og ikke bare være en teknisk beskrivelse
                    av hva som har gått galt. Design og kode skal følge Designsystemet.
                </li>
            </ol>
        </div>
        ...
        <div className="section">
            ...
            <p>
                Mye bør fungere hvis du følger Designsystemet. Følgende liste er ikke uttømmende, men viser de viktigste
                tingene som er lurt å sjekke hyppig.
            </p>
            <ol>
                <li>Fungerer alt med tastatur?</li>
                <ul>
                    <li>
                        Du kan nå og betjene alle interaktive elementer kun med tastatur
                        (knapper, lenker, radiobokser,…)
                    </li>
                    <li>
                        Siden har hoppe-over-blokker (&quot;hopp til hovedmeny&quot;
                        og &quot;hopp til hovedinnhold&quot;). Disse blir synlige når man tab-er gjennom siden.
                    </li>
                    <li>
                        Man ser tydelig hvor man er når man bruker tastatur for å
                        navigere. Fokusmarkeringen er en gul ramme (se //lenke til siden//)
                    </li>
                    <li>
                        Siden er kodet i en logisk rekkefølge, og tab-rekkefølgen
                        følger den visuelle rekkefølgen.
                    </li>
                    <li>
                        Hjelpemidler får med seg når elementer er åpent eller lukket (for
                        eksempel lameller) og lukker man et element, så er man på samme sted som man var da man
                        åpnet elementet
                    </li>
                    <li>
                        Ting endrer seg ikke bare fordi de får fokus
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        Tabeller er kodet som tabeller, th har scope //når vi har tabeller inne i Designsystemet lenke
                        til selve siden//
                    </li>
                ...
                <ul>
                    ...
                    <li>
                        Sider/bolker der det kan oppstå flere feil skal ha en feiloppsummeringsboks.
                        Boksen skal få fokus og aria-varsel.
                    </li>
                ...
                <ul>
                    <li>
                        ...
                        <a // eslint-disable-next-line max-len
                            href="https://www.paciellogroup.com/blog/2013/05/testing-and-debugging-ios-accessibility-for-voiceover/"
                        >
