# less-module: nav-frontend-lesmerpanel-style
...
```
npm install nav-frontend-core nav-frontend-lesmerpanel-style nav-frontend-paneler-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lesmerpanel-style
