  ...
  return (
    <li className="group relative border-l border-border-subtle">
      <BodyShort
        ...
        className={cl(
          "ml-2 flex py-05 focus:outline-none *:focus-visible:shadow-focus group-last:last-of-type:pb-0 group-first-of-type:pt-0",
          ...
          {
            "text-text-subtle before:w-0 before:bg-gray-400  before:duration-100 before:ease-[cubic-bezier(0.3,0,0.15,1)] hover:text-text-default hover:before:w-1":
              !selected,
      ...
      >
        <span
          className={cl(
            "w-full rounded px-2 py-05 transition-colors duration-200 ease-[cubic-bezier(0.3,0,0.15,1)]",
            {
