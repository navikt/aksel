...
import 'nav-frontend-hjelpetekst-style/css/index.css';

export interface HjelpetekstProps extends React.HTMLAttributes<HTMLButtonElement> {
    /**
...
class Hjelpetekst extends React.Component<HjelpetekstProps, State> {
    ...
    render() {
        const {
            children, className, popoverProps, type, tittel, ...rest
        } = this.props;
