...
<Panel className="panel--grey">
    <Normaltekst>01.09.16 / <Undertekst tag="span"><strong>Viktig informasjon</strong></Undertekst></Normaltekst>
    <Undertittel style={{margin:'0.5rem 0'}}>En gammeldags juleaften</Undertittel>
    <Normaltekst>
