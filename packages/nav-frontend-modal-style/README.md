# less-module: nav-frontend-modal-style
...
```
npm install nav-frontend-core nav-frontend-lukknapp-style nav-frontend-modal-style nav-frontend-paneler-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-modal-style
