...
<Panel className="panel--grey">
    <Undertittel tag="h3">Vi vil gjerne ha dine innspill!</Undertittel>
    <p>
        Har du forslag til endringer som kan gjøre språksidene i Designsystemet bedre? Send oss gjerne en e-post: sprak.nav.no@nav.no. 
    </p>
</Panel>
