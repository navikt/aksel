...
### Installering:
```
npm install nav-frontend-lesmerpanel classnames nav-frontend-lesmerpanel-style nav-frontend-paneler-style nav-frontend-core prop-types react nav-frontend-chevron nav-frontend-chevron-style --save
```
