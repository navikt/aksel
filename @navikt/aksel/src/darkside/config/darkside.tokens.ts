import { getFrameworkRegexes } from "./tokenRegex";
...
type NewTokensWithRegex = Record<
  string,
  { tw: string; regexes: ReturnType<typeof getFrameworkRegexes> }
>;

export const newTokens: NewTokensWithRegex = Object.entries(
...
const updatedTokensWithoutRegex: Record<
  string,
  Omit<UpdatedTokensData, "regexes">
> = {
...
export const updatedTokens: Record<string, UpdatedTokensData> = Object.entries(
  updatedTokensWithoutRegex,
