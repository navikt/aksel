...
export interface CheckboksPanelGruppeProps {
    ...
    renderAsDiv?: boolean;
    /**
     * Styling klasse for div som benyttes dersom renderAsDiv valget er satt.
     */
    divClassName?: string;
}
...
class CheckboksPanelGruppe extends React.Component<CheckboksPanelGruppeProps> {
    render() {
        const { checkboxes, legend, feil, onChange, renderAsDiv, divClassName } = this.props;
        return (
            <SkjemaGruppe className="inputPanelGruppe" feil={feil}>
                {renderAsDiv ? 
                    <div className={divClassName} role="group">
