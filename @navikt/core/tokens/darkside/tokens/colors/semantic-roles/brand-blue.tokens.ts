...
export const brandBlueSemanticTokenConfig = {
  ...
  text: {
    "brand-blue": {
      ...
      comment: "Sterk farge for tekst og ikoner for rollen brand blue. Godkjent på alle bakgrunner unntatt strong.",
    },
    "brand-blue-subtle": {
      value: "{ax.brand-blue.800.value}",
      type: "color",
      group: "text.brand-blue",
      comment: ": Standard farge for tekst og ikoner med rollen brand blue. Godkjent på alle bakgrunner unntatt strong.",
    },
    "brand-blue-icon": {
      value: "{ax.brand-blue.600.value}",
      type: "color",
