...
class StegindikatorSteg extends React.Component<StegindikatorStegProps> {
    ...
    getInnerStep() {
        const labelTemplate = (<div className="stegindikator__steg-label">{this.props.label || this.props.children}</div>);
    ...
    render() {
        ...
        return (
            <li className={stegCls(this.props)} {...domProps} aria-current={(this.props.aktiv) ? 'step' : undefined }>
                {this.getInnerStep()}
            </li>
        );
    }
