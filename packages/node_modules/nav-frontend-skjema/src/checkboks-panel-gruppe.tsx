...
import { SkjemaGruppe, SkjemaGruppeFeilContext, SkjemaGruppeFeilContextProps } from '.';
...
export class CheckboksPanel extends React.Component<CheckboksPanelProps, CheckboksPanelState> {
    ...
    render() {
        const {
            id, label, subtext, disabled, ...other
        } = this.props;
...
class CheckboksPanelGruppe extends React.Component<CheckboksPanelGruppeProps> {
    render() {
        const {
            checkboxes, legend, feil, onChange, className, ...other
        } = this.props;
