# react-module: nav-frontend-lukknapp

Standard lukknapp for nav-frontend.
...
```
npm install classnames nav-frontend-core nav-frontend-lukknapp nav-frontend-lukknapp-style prop-types react --save
```
