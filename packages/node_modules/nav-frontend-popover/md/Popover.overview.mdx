...
kan også være `under`, `høyre`, `venstre`, `over-venstre`, `over-høyre`, `under-venstre` eller `under-høyre`.
...
<Example>
    <video src={PopoverEdgeVideo} controls autoplay loop preload="auto" />
</Example>
