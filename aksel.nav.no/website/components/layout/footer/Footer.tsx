            ...
            <BodyShort as="ul" className="mt-5 grid gap-2">
              <li>
                <NextLink href="/artikkel/om-aksel" passHref>
                  <Link className="text-text-on-inverted focus:text-text focus:shadow-focus focus:text-text-default focus:bg-blue-200 focus:shadow-blue-200">
                    Om Aksel
                  </Link>
                </NextLink>
              </li>
              ...
              {variant === "aksel" && (
                <li>
                  <Link
                    className="text-text-on-inverted focus:text-text focus:shadow-focus focus:text-text-default focus:bg-blue-200 focus:shadow-blue-200"
        ...
        <div className="grid xl:grid-cols-3 xl:gap-6">
          ...
          <div className="hidden self-end xl:block">
            ...
            <NextLink href="/side/personvernerklaering" passHref>
              <a className="focus:bg-border-focus-on-inverted focus:text-text focus:text-text-default focus:ring-border-focus-on-inverted outline-none hover:underline focus:no-underline focus:ring">
          ...
          <div className="block self-end xl:hidden">
            &copy; 2022 NAV |{" "}
            <NextLink href="/side/personvernerklaering" passHref>
              <a className="focus:bg-border-focus-on-inverted focus:text-text focus:ring-border-focus-on-inverted outline-none hover:underline focus:no-underline focus:ring">
                Personvernerklæring og informasjonskapsler
              </a>
            </NextLink>
          </div>
