...
export interface NavFrontendInputProps extends React.InputHTMLAttributes<HTMLInputElement> {
     ...
     */
    feil?: SkjemaelementFeil | boolean;
    /**
    ...
    render() {
        ...
        return (
            <div className={cls(className)}>
                {label && <label className="skjemaelement__label" htmlFor={inputId}>{label}</label>}
                <input
                    type="text"
                    ...
                    ref={inputRef}
                />
                {typeof feil !== 'boolean' && <SkjemaelementFeilmelding feil={feil} />}
            </div>
        );
    }
}
