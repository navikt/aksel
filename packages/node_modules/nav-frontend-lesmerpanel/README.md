...
### Installering:
```
npm install classnames nav-frontend-chevron nav-frontend-chevron-style nav-frontend-core nav-frontend-lesmerpanel nav-frontend-lesmerpanel-style nav-frontend-paneler-style prop-types react react-collapse --save
```
