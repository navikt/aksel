...
import Lenke from "./..";
import { FileIcon } from "../../../website/guideline-app/app/assets/images/svg";

## Normal

Tekstlenker skal ha tekstfarge [@navBla](/resources/colors) (#0067C5) med normal underlinje som forsvinner ved hover.
