...
### Installering:
```
npm install lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-knapper-style nav-frontend-toggle nav-frontend-toggle-style nav-frontend-typografi-style prop-types react --save
```
