...
### Installering:
```
npm install nav-frontend-alertstriper babel-polyfill classnames nav-frontend-alertstriper-style nav-frontend-core nav-frontend-ikoner-assets nav-frontend-paneler-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
