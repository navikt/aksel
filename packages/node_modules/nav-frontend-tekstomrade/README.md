...
### Installering:
```
npm install nav-frontend-tekstomrade nav-frontend-lenker classnames nav-frontend-lenker-style nav-frontend-core prop-types react nav-frontend-typografi nav-frontend-typografi-style --save
```
