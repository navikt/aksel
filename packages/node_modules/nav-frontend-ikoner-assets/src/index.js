...
export default class Icon extends Component {
  ...
  getIcon(kind) {
    ...
    switch (kind) {
      ...
      case ('tilsette'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 24 24" ><title>Tilsette</title><g fill="none" fillRule="evenodd"><path stroke="#0067C5" d="M20.147 3.884A11.43 11.43 0 0 0 11.999.5C5.671.5.512 5.649.5 11.977a11.422 11.422 0 0 0 3.352 8.139 11.423 11.423 0 0 0 8.126 3.384c6.347 0 11.51-5.147 11.522-11.48a11.419 11.419 0 0 0-3.353-8.136z"/><path d="M18.262 12.522H5.739a.522.522 0 0 1 0-1.044h12.523a.522.522 0 0 1 0 1.044z" fill="#0067C5" mask="url(#mask-2)"/><path d="M18.262 12.522H5.739a.522.522 0 0 1 0-1.044h12.523a.522.522 0 0 1 0 1.044z" fill="#0067C5" mask="url(#mask-2)" transform="rotate(90 12 12)"/></g></svg>);
