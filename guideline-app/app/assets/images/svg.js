...
export const CheckIcon = (props) => {
    ...
    return (
        <svg version="1.1" fill={fill} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...rest}>
            { rest.title && <title>{rest.title}</title> }
            <path d="M23.854,5.396l-3.5-3.5c-0.195-0.195-0.512-0.195-0.707,0L7.5,14.043l-3.146-3.146c-0.195-0.195-0.512-0.195-0.707,0
...
export const CrossIcon = (props) => {
    ...
    return (
        <svg version="1.1" fill={fill} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" {...rest}>
            { rest.title && <title>{rest.title}</title> }
            <path d="M17.207,12.01l6.658-6.634c0.096-0.093,0.149-0.22,0.149-0.353c0-0.133-0.053-0.26-0.146-0.354L19.375,0.16
...
export const NAVLogoCircle = () => (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168.9 168.9">
        <path
            fill="#C30000"
...
export const TypoIcon = (props) => (
    ...
    >
        <g>
            <path d="M0,46.9L14.7,0h12.7l14.7,46.9H30.9L28,35.8H13.7l-2.9,11.2H0z M17,23.2l-1.2,4.3h10l-1.1-4.3c-0.7-2.4-1.3-4.8-1.9-7.5
                c-0.6-2.6-1.2-5.2-1.9-7.6h-0.3c-0.6,2.5-1.2,5.1-1.8,7.7C18.3,18.3,17.7,20.8,17,23.2z"
            />
            <path d="M56.4,47.8c-1.6,0-3.1-0.3-4.4-0.8c-1.3-0.6-2.4-1.3-3.3-2.3c-0.9-1-1.6-2.1-2.1-3.4C46,40,45.7,38.5,45.7,37
...
export const ButtonIcon = (props) => (
    ...
    >
        <g>
            <path style={{ fill: '#ffffff' }} d="M141,46H4c-1.7,0-3-1.3-3-3V4c0-1.7,1.3-3,3-3h137c1.6,0,3,1.3,3,3v39C144,44.7,142.6,46,141,46z" />
            <path
                style={{ fill: '#0067c5' }}
        ...
        <g>
            <path style={{ fill: '#0067c5' }} d="M46.3,29.6V17.9h2.6v4.8H49l3.5-4.8h2.9l-3.5,4.7l4.2,7.1h-2.9l-2.9-5l-1.4,1.8v3.1H46.3z" />
            <path
                style={{ fill: '#0067c5' }}
...
export const VeilederIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54 93">
        ...
        <path fill="#5c4378" d="M38.7 50.2c6 2.9 15.3 10.9 15.3 18.3V93H0V68.5c0-7.1 8.5-14.8 14.5-18-.3.2-.5.3-.5.3 1 1.7 3.8 9.2 12.4 9.2C35 60 39 51.9 39 50.4c-.1-.1-.2-.2-.3-.2z" />
        <path fill="#d2242a" d="M46.7 76H31.2c-.7 0-1.3-.6-1.2-1.3v-8.5c0-.7.6-1.3 1.3-1.3h15.5c.7 0 1.3.6 1.3 1.3v8.5c-.1.7-.7 1.3-1.4 1.3" />
        <path fill="#fff" d="M42.9 71c0 2.1-1.7 3.8-3.8 3.8-2.1 0-3.8-1.7-3.8-3.8s1.7-3.8 3.8-3.8c2.1 0 3.8 1.7 3.8 3.8m-8.7 1.7h-.7l.8-1.9h.7l-.8 1.9zm9.3 0H43l.8-1.9h.5l-.8 1.9zm1.2 0h-.2l.8-1.9h.2l-.8 1.9z" />
        <path fill="#c52d35" d="M36.2 72.7h.6s.1 0 .1-.1v-1.8s0-.1-.1-.1h-.6s-.1 0-.1.1l-.2.6v.1h.2l.1 1.2c0-.1 0 0 0 0" />
        <path fill="#c52d35" d="M37.5 72.7h.6s.1 0 .1-.1v-1.8s0-.1-.1-.1h-.9s-.1 0-.1.1l-.2.6-.1.1h.5c.1 0 .2.1.2.2v1c-.1-.1-.1 0 0 0m2.6-1.9h-.6s-.1 0-.1.1v1.8s0 .1.1.1h.6s.1 0 .1-.1l.2-.6V72h-.2l-.1-1.2" />
        <path fill="#c52d35" d="M37.7 72.7h.4s.1 0 .1-.1l.2-.6v-.1h-.2c0 .1-.5.8-.5.8zm3.9-1.9h.7s.1 0 0 .1l-.7 1.8H41l.6-1.9" />
        <path fill="#c52d35" d="M40.8 70.8h-1c-.1 0 .3.1.3.1l.7 1.7s0 .1.1.1h.6l-.7-1.9m-1.3.6v.4s-.1-.4-.3-.4c-.3 0-.3.2-.3.3 0 .1.1.3.2.3h.5l-.3.7H39c-.2 0-.9-.3-.9-.9 0-.6.5-1 .9-1 .2-.1.5.2.5.6 0-.1 0-.1 0 0z" />
        ...
        <path fill="#e7e5e2" d="M47.2 35.3C44.7 45.6 36.6 53.1 27 53.1S9.3 45.6 6.8 35.3c-.2.1-.5.1-.8.1-1.1 0-2-.8-2-1.7v-7c0-1 .9-1.7 2-1.7h.2C7.7 13.1 16.4 4 27 4c10.6 0 19.3 9.1 20.8 21h.2c1.1 0 2 .8 2 1.7v7c0 1-.9 1.7-2 1.7-.3 0-.5 0-.8-.1z" />
        <path fill="#635e59" d="M19 27.6c-1.4.1-1.9-2-1.4-3.4.1-.3.6-1.5 1.4-1.5.8 0 1.2.7 1.3.8.6 1.4.3 4-1.3 4.1m16.2 0c1.4.1 1.9-2 1.4-3.4-.1-.3-.6-1.5-1.4-1.5-.8 0-1.2.7-1.3.8-.6 1.4-.3 4 1.3 4.1" />
        <path fill="#d1bfa3" d="M26.8 34.6c-.4 0-.7-.1-1-.2-.3-.1-.4-.4-.3-.7.1-.3.4-.4.7-.3.5.2 1.5.1 2.2-.4.7-.4 1.1-1 1.2-1.5.1-.4-.1-.9-.4-1.3-.2-.2-.8-.2-1.6-.1-.3 0-.5-.1-.6-.4 0-.3.1-.5.4-.6 1.2-.2 2.1 0 2.6.6.5.7.8 1.4.6 2.1-.1.8-.7 1.6-1.7 2.2-.6.3-1.4.6-2.1.6z" />
        <path fill="#593a32" d="M27.1 42.1h-.3c-5.3-.2-7.3-4.1-7.4-4.3-.1-.3 0-.6.2-.7.2-.1.6 0 .7.2.1.1 1.9 3.6 6.6 3.8 4.7.2 6.4-3.7 6.4-3.7.1-.3.4-.4.7-.3.3.1.4.4.3.7-.1 0-2.1 4.3-7.2 4.3z" />
        <path fill="#f6b873" d="M6.6 30.7c.1-.1.1-.2.1-.3v-2c-.1-5.6 1.8-8.1 3.4-10.1 0 0-1 4.3-.3 3.4 3.8-5 21.4-1.6 25-8.1.5 3.6-4.1 4.6-4.1 4.6 3.7.7 6.9-.8 7.7-2.5.3 1.4-.6 2.4-1.9 3.4 4.5-.9 4.6-4 4.6-4 .6 4.1 5.3 2.5 5.3 9.3v6c0 .3.2.6.5.6h.5c.3 0 .5-.3.5-.6V26c.3-15.6-8.5-26-20.6-26C15.9 0 5 10.4 5 24.1v6.3c0 .4.2.6.5.6h.6c.2 0 .3-.1.5-.3" />
    ...
    <svg viewBox="0 0 494 447" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(-9.000000, -28.000000)">
                <g transform="translate(9.000000, 28.000000)">
                    <g fill="#FFAE00">
                        <polygon transform="translate(247.000000, 223.500000) rotate(-180.000000) translate(-247.000000, -223.500000) " points="247 5.68434189e-14 494 287 387 432 247 447 107 432 -2.84217094e-13 287" />
                    </g>
                    <g transform="translate(0.000000, 160.000000)" fill="#EC6C00">
                        <polygon transform="translate(247.000000, 143.500000) rotate(-180.000000) translate(-247.000000, -143.500000) " points="247 1.13686838e-13 494 287 -5.68434189e-14 287" />
                    </g>
                    <g transform="translate(100.000000, 160.000000)" fill="#FFAE00">
                        <polygon transform="translate(147.000000, 143.500000) rotate(-180.000000) translate(-147.000000, -143.500000) " points="147 0 294 287 2.84217094e-13 287" />
                    </g>
                    <g transform="translate(100.000000, 0.000000)" fill="#FFEFB4">
                        <polygon transform="translate(147.000000, 80.000000) rotate(-180.000000) translate(-147.000000, -80.000000) " points="147 160 294 2.70983236e-12 5.68434189e-14 -5.68434189e-14" />
                    </g>
                    <g transform="translate(0.000000, 15.000000)" fill="#FFAE00">
                        <polygon transform="translate(53.500000, 72.500000) rotate(-180.000000) translate(-53.500000, -72.500000) " points="-2.27373675e-13 145 55 72 107 2.72848411e-12 6 5.68434189e-14" />
                    </g>
                    ...
                    <g transform="translate(100.000000, 0.000000)" fill="#FED305">
                        <polygon transform="translate(73.500000, 80.000000) rotate(-180.000000) translate(-73.500000, -80.000000) " points="140 145 147 2.95585778e-12 2.27373675e-13 160" />
                    </g>
                    <g transform="translate(247.000000, 0.000000)" fill="#FED305">
                        <polygon transform="translate(73.500000, 80.000000) scale(-1, 1) rotate(-180.000000) translate(-73.500000, -80.000000) " points="140 145 147 0 -1.42108547e-14 160" />
                    </g>
                </g>
            </g>
        </g>
...
export const LinkIcon = () => (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <g>
            <path d="M6.5,22.8c-0.9,0-1.8-0.4-2.5-1L2.3,20c-1.4-1.4-1.4-3.6,0-5l4-4c0.9-0.9,2.6-0.9,3.5,0l0.1,0.1l-0.7,0.7l-0.1-0.1
...
export const FileIcon = () => (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <g>
            <path d="M20.5,24h-17C3.2,24,3,23.8,3,23.5v-23C3,0.2,3.2,0,3.5,0h11c0,0,0,0,0,0c0.1,0,0.3,0.1,0.4,0.1l6,6
