# less-module: nav-frontend-knapper-style
...
```
npm install nav-frontend-core nav-frontend-knapper-style nav-frontend-typografi-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-knapper-style
