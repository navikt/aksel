...
import { GodPraksisFeedbackProvider } from "./GodPraksisFeedback.provider";

function GodPraksisFeedback() {
  return (
    <GodPraksisFeedbackProvider loggedIn={false}>
      <BoxNew
        borderRadius="large"
        borderWidth="1"
