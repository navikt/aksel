...
### Installering:
```
npm install nav-frontend-veilederpanel react prop-types nav-frontend-veileder classnames nav-frontend-veileder-style nav-frontend-core nav-frontend-veilederpanel-style nav-frontend-paneler-style nav-frontend-typografi-style --save
```
