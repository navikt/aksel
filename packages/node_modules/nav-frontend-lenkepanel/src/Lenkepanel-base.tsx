...
export interface LenkepanelBaseProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
    /**
     * Klassenavn
     */
    className?: string;
...
class LenkepanelBase extends React.Component<LenkepanelBaseProps> {
    ...
    render() {
        const {
            className, children, linkCreator = (props) => <a {...props} />, border, ...renderProps
        } = this.props;
