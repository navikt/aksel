...
### Installering:
```
npm install classnames nav-frontend-core nav-frontend-hjelpetekst nav-frontend-hjelpetekst-style nav-frontend-ikoner-assets nav-frontend-lenker-style nav-frontend-lukknapp nav-frontend-lukknapp-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
