...
class Popover extends React.Component<PopoverProps, PopoverState> {
    ...
    componentDidMount() {
        this.scrollParents = getScrollParents(this.popoverRef.current);
    ...
    componentWillReceiveProps(nextProps) {
        if (!this.props.ankerEl && nextProps.ankerEl) {
            this.setState({
                ...
                if (this.props.autoFokus) this.popoverRef.current.focus();
            });
    ...
    checkFocus = () => {
        window.setTimeout(() => {
            ...
            const ankerEl = this.props.ankerEl;
            if (
                focusElement === popoverEl ||
                focusElement === ankerEl ||
    ...
    calculatePosition = (props) => {
        const popoverOffset = this.popoverRef.current.getBoundingClientRect();
    ...
    handleResize = () => {
        if (!this.state.åpen) return;
        this.cachedMeasurements = this.popoverRef.current.getBoundingClientRect();
