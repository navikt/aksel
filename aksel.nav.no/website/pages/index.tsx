            ...
            <section className="bg-deepblue-50 relative px-4 pt-16 pb-24">
              ...
              <div className="dynamic-wrapper relative z-10 -mt-16">
                <Heading
                  level="2"
                  size="small"
                  className="text-text-inverted uppercase"
                >
                  Temaer
                </Heading>
                ...
                {filteredTemas.length > 6 && (
                  <NextLink href="/tema">
                    <a className="text-text hover:text-deepblue-700 mt-6 inline-block underline hover:no-underline">
                      Utforsk alle temaer
                    </a>
                  </NextLink>
                )}
                  ...
                  <div className="order-1 mt-16 xl:pl-12 2xl:col-span-2 2xl:mt-44">
                    ...
                    {bloggs?.length > 6 && (
                      <NextLink href="/blogg" passHref>
                        <a
                          className="text-text hover:text-deepblue-700 mt-6 inline-block underline hover:no-underline"
                          href="#"
                        >
                          Flere bloggposter
                        </a>
