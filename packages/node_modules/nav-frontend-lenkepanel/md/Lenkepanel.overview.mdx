...
Hvis man bruker `LenkepanelBase` kan man bestemme et helt egendefinert React/HTML-innhold, men 
vær obs på at det finnes retningslinjer for hvordan slike paneler bør se ut.
