# react-module: nav-frontend-popover
...
```
npm install classnames lodash.throttle nav-frontend-js-utils nav-frontend-popover nav-frontend-popover-style prop-types react react-dom --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-popover
