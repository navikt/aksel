...
import SkjemaelementFeilmelding, { skjemaelementFeilmeldingShape, SkjemaelementFeil } from './skjemaelement-feilmelding';
...
(Textarea as React.ComponentClass).propTypes = {
    /**
...
(Textarea as React.ComponentClass).defaultProps = {
    maxLength: 2000,
    textareaClass: '',
    id: undefined,
    name: undefined,
