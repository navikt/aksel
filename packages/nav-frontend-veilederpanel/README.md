# react-module: nav-frontend-veilederpanel
...
```
npm install classnames lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-paneler-style nav-frontend-typografi-style nav-frontend-veileder nav-frontend-veileder-style nav-frontend-veilederpanel nav-frontend-veilederpanel-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-veilederpanel
