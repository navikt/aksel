...
Denne modulen er flyttet til [nav-frontend-skjema-style](https://www.npmjs.com/package/nav-frontend-skjema-style)-modulen og
vil ikke lengre bli vedlikeholdt her.

### Installering:
```
npm install nav-frontend-toggle-style
```
