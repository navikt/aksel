...
class ModalWrapper extends Component {
    ...
    render() {
        const { children, closeButton, shouldCloseOnOverlayClick, ...props } = this.props;
        return (
            <Modal
                {...props}
            ...
            >
                {children}
                { closeButton && <button
                    className={classnames('modal__lukkknapp', shouldCloseOnOverlayClick || 'modal__lukkknapp--shake')}
