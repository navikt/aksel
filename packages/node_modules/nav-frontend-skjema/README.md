...
### Installering:
```
npm install nav-frontend-skjema classnames nav-frontend-js-utils lodash.throttle prop-types react nav-frontend-skjema-style nav-frontend-core nav-frontend-typografi-style --save
```
