    ...
    <>
      {full ? (
        <BodyShort
          ...
          onClick={onOpen}
          as="button"
          className="border-border hover:border-link focus-visible:shadow-focus group relative w-full max-w-[28rem] rounded border bg-white py-4 pr-4 pl-16 text-left focus:outline-none"
        >
          <SearchIcon
            aria-hidden
        ...
        <button
          ...
          className={cl(
            ...
            {
              " text-text-inverted focus-visible:shadow-focus-inverted-inset hover:bg-gray-100/10":
