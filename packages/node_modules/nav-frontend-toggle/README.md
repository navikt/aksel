# react-module: nav-frontend-toggle
...
```
npm install classnames lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-knapper-style nav-frontend-toggle nav-frontend-toggle-style nav-frontend-typografi-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-toggle
