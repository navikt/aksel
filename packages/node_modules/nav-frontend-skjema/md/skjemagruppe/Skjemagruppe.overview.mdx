...
Bruk `propagereFeilTilChildren`-propen for å bestemme om `feil`-propen til skjermgruppen skal propageres til barnekomponenter.

<Example>
    <SkjemaGruppe feil="Her er det noe feil" propagereFeilTilChildren>
        <Input label="Fornavn" />
