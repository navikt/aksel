# less-module: nav-frontend-telefon-style

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-telefon-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-telefon-style
<!-- AUTO-GENERATED-CONTENT:END *-->
