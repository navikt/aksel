...
import 'nav-frontend-ekspanderbartpanel-style/css/index.css';
import { guid, keyCodes } from 'nav-frontend-js-utils';

const cls = (props) => classnames('ekspanderbartPanel', props.className, {
    'ekspanderbartPanel--lukket': !props.apen,
    'ekspanderbartPanel--apen': props.apen,
    'ekspanderbartPanel--border': props.border
});

export interface EkspanderbartpanelBaseProps extends React.HTMLAttributes<HTMLButtonElement> {
    /**
...
class EkspanderbartpanelBase extends React.PureComponent<EkspanderbartpanelBaseProps, {}> {
            ...
            <div className={cls(this.props)}>
                ...
                >
                    <CollapseComponent
                        ...
                        {...collapseProps}
                    >
                        <div className="ekspanderbartPanel__innhold">
                            {children}
                        </div>
                    </CollapseComponent>
                </div>
