...
const snakkebobleCls = (hoyre, className) => classNames('snakkeboble', ...className.split(' '), {
 ...
 */
const Snakkeboble = (props: SnakkebobleProps) => {
    const { dato, topp, children, pilHoyre, ikonClass, className } = props;
    ...
    return (
        <div className={snakkebobleCls(pilHoyre, className)}>
            ...
            <Panel className="snakkeboble-panel">
                {toppTekst &&
                    <Undertekst className="snakkeboble-panel__topp">{toppTekst}</Undertekst>
                }
...
(Snakkeboble as React.FC).defaultProps = {
    /**
...
(Snakkeboble as React.FC).propTypes = {
    /**
     * Toppteksten (tittel) for meldingen
     */
    topp: PT.string,
