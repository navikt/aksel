...
const tokens = [
  ...
  ["--navds-semantic-color-interaction-primary-hover-subtle","--a-surface-action-subtle"],
  ...
  /* ??? */
  ["--navds-guide-panel-color-border ","--a-blue-400"],
  ["--navds-guide-panel-color-illustration-background ","--a-blue-200"],
