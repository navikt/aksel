  ...
  return (
    <div className="z-[1050] ml-auto mr-4 flex justify-center lg:ml-0 lg:mr-0">
      ...
      <ReactModal
        ...
        aria={{ modal: true }}
        contentLabel="Søk"
        className="bg-surface-default absolute inset-0 mx-auto my-auto  flex h-[90%] max-h-[42rem] w-full max-w-[90%] flex-col overflow-x-hidden rounded-lg shadow-xl md:h-[80%] lg:max-w-4xl"
