# less-module: nav-frontend-toggle-style
...
```
npm install nav-frontend-core nav-frontend-knapper-style nav-frontend-toggle-style nav-frontend-typografi-style react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-toggle-style
