# less-module: nav-frontend-telefoninput-style

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-telefoninput-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-telefoninput-style
<!-- AUTO-GENERATED-CONTENT:END *-->
