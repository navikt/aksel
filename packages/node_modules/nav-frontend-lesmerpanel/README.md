...
### Installering:
```
npm install @nkbt/react-collapse classnames nav-frontend-chevron nav-frontend-chevron-style nav-frontend-core nav-frontend-lesmerpanel nav-frontend-lesmerpanel-style nav-frontend-paneler-style prop-types react --save
```
