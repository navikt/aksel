...
export const infoSemanticTokenConfig = {
  bg: {
    ...
    "info-moderate": {
      ...
      type: "color",
      group: "background.info",
      comment: "En medium-svak bakgrunnsfarge som brukes til dekor. Om den brukes på meningsbærende elementer må den kombineres med en godkjent border (f.eks. alert info).",
    },
    "info-moderateA": {
  ...
  text: {
    info: {
      ...
      type: "color",
      group: "text.info",
      comment: "Sterk farge for tekst og ikoner for rollen info. Godkjent på alle bakgrunner unntatt strong.",
    },
    "info-subtle": {
      value: "{ax.info.800.value}",
      type: "color",
      group: "text.info",
      comment: "Standard farge for tekst og ikoner med rollen info. Godkjent på alle bakgrunner unntatt strong.",
    },
    "info-icon": {
      value: "{ax.info.600.value}",
      type: "color",
