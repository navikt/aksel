...
const colors = {
  navRod: {
    ...
    label: "NAV Rød",
    description:
      "NAV Rød er hovedprofilfarge. Brukes i logoen og enkelte elementer som bærer identiteten til NAV.",
  },
  navMorkGra: {
  ...
  navLysGra: {
    ...
    label: "NAV Lys grå",
    description:
      "Bakgrunn skal hovedsakelig være lys og luftig, med mye bruk av hvit og NAV lys grå.",
  ...
  navBla: {
    ...
    label: "NAV Blå",
    description:
      "NAV Blå skal indikere mulighet for interaksjon med et visuelt element. Eks. " +
  ...
  navDypBla: {
    ...
    label: "NAV Dyp Blå",
    description:
      "NAV Dyp Blå benyttes som støtte farge til NAV blå for å indikere forandring i status. " +
  ...
  navLilla: {
    ...
    label: "NAV Lilla",
    description:
      "NAV Lilla benyttes som støtte farge til NAV dyp blå for å indikere en tredje status " +
  ...
  redError: {
    ...
    description:
      "NAV Murstein Rød indikerer feil eller mangel av informasjon. Kan også indikere at en handling " +
      "fra bruker kan medføre tap av data eller avbryte en pågående prosess.",
    contrastColors: {
      hvit: { hex: "#fff", label: "murstein rød / hvit" },
      navLysGra: {
        hex: lessvars["@navLysGra"],
        label: "murstein rød / lys grå",
      },
      pinkErrorBg: {
        hex: lessvars["@pinkErrorBg"],
        label: "murstein rød / rosa",
      },
    },
  },
  pinkErrorBg: {
    ...
    label: "NAV Rosa",
    description:
      "NAV Rosa er en støtte farge til Murstein Rød, og kan brukes som bakgrunn til feilmeldinger.",
  ...
  navGronn: {
    ...
    label: "NAV Grønn",
    description:
      "NAV Grønn indikerer at en handling har blitt gjennomført og vellykket, skal sikre at bruker " +
  ...
  navOransje: {
    ...
    label: "NAV Oransje",
    description:
      "NAV Oransje skal brukes for å fremheve viktig innhold eller informasjon",
    textColor: lessvars["@navMorkGra"],
  },
  orangeFocus: {
    hex: lessvars["@orangeFocus"],
