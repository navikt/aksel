...
class ModuleBrowser extends React.Component {
  constructor(props) {
    ...
    this.modules = Object.keys(this.props.data.packageModules)
      .sort()
      .map((key) => this.props.data.packageModules[key]);
      ...
      <div className="module-browser">
        ...
        <Panel border className="module-browser__wrapper">
          ...
          <div className="module-browser__content">
            ...
            <PropTypeTable
              docgenInfo={this.modules[this.state.activeModule].__docgenInfo}
            />
          </div>
        </Panel>
      </div>
