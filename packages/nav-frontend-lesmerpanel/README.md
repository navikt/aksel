# react-module: nav-frontend-lesmerpanel
...
```
npm install classnames lodash.throttle nav-frontend-chevron nav-frontend-chevron-style nav-frontend-core nav-frontend-js-utils nav-frontend-lesmerpanel nav-frontend-lesmerpanel-style nav-frontend-paneler-style prop-types react react-collapse --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lesmerpanel
