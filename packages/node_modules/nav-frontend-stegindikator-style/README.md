...
Installering:
```
npm install nav-frontend-stengindikator-style
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-stengindikator-style