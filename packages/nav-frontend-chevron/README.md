# react-module: nav-frontend-chevron
...
```
npm install classnames nav-frontend-chevron nav-frontend-chevron-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-chevron
