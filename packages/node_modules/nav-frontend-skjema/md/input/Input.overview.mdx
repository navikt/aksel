...
<Alertstripe type="info">
    Les mer om hvorfor man bør bruke <InlineCode>inputMode="numeric"</InlineCode> og <InlineCode>pattern="[0-9]*"</InlineCode> på <Lenke href="/components/input/accessibility#unntak">komponentens tilgjengelighets-sider</Lenke>.
</Alertstripe>
