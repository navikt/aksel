# less-module: nav-frontend-lukknapp-style
...
```
npm install nav-frontend-core nav-frontend-lukknapp-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lukknapp-style
