# less-module: nav-frontend-ikoner-webfont-style

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-ikoner-webfont-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-ikoner-webfont-style
<!-- AUTO-GENERATED-CONTENT:END *-->