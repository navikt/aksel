...
### Installering:
```
npm install babel-polyfill babel-runtime classnames nav-frontend-core nav-frontend-etiketter nav-frontend-etiketter-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
