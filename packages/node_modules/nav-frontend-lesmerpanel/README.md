...
### Installering:
```
npm install nav-frontend-lesmerpanel classnames nav-frontend-chevron nav-frontend-chevron-style prop-types react nav-frontend-lesmerpanel-style nav-frontend-core nav-frontend-paneler-style --save
```
