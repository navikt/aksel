...
import 'nav-frontend-lenkepanel-style/css/index.css';
...
class Lenkepanel extends React.PureComponent<LenkepanelProps> {
    render() {
        const { children, tittelProps = 'undertittel', ...renderProps } = this.props;
        const headingConfig = { type: tittelProps, tag: 'span' };
        // eslint-disable-next-line max-len
        const heading = <Typografi key="heading" {...headingConfig} className="lenkepanel__heading">{children}</Typografi>;

        return (
            <LenkepanelBase {...renderProps}>
                {heading}
            </LenkepanelBase>
        );
    }
