...
### Installering:
```
npm install nav-frontend-tekstomrade classnames nav-frontend-core nav-frontend-typografi nav-frontend-typografi-style prop-types react sanitize-html --save
```
