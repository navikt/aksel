# less-module: nav-frontend-popover-style
...
```
npm install nav-frontend-popover-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-popover-style
