...
const ikonKind = (type, solid) => {
    const kindMap = {
        ...
        'feil-sirkel-fylt': type === 'feil' && !solid,
...
AlertStripe.propTypes = {
    ...
    type: PT.oneOf(['advarsel', 'suksess', 'info', 'feil']).isRequired,
    solid: PT.bool,
    className: PT.string
};
