# react-module: nav-frontend-stegindikator
...
```
npm install classnames lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-stegindikator nav-frontend-stegindikator-style nav-frontend-typografi-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-stegindikator
