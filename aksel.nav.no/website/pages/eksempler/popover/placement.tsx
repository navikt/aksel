...
export const args = {
  index: 3,
  desc: "Her kan du teste ulike 'placement'-verdier. Popover styrer selv plassering hvis det ikke er plass i valgt retning. Dette kan overstyres ved å sette `flip` til `false`.",
};
