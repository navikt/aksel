...
module.exports = {
  baseUrl: "/playroom/",
  components: path.resolve("./playroom/components.ts"),
  outputPath: path.resolve("./public/playroom"),
  // Optional:
  title: "Aksel Sandbox",
  snippets: path.resolve("./playroom/snippets.ts"),
  widths: [320, 1280],
  port: 9000,
  // frameComponent: path.resolve("./playroom/FrameComponent.tsx"),
  openBrowser: false,
