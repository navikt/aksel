...
class OtherComponentsPage extends React.Component {
  render() {
    ...
    const editUrl =
      "https://github.com/navikt/nav-frontend-moduler/edit/master/guideline-app/app/data/components/other.json"; // eslint-disable-line
        ...
        <div className="section" id="disclaimer">
          ...
          <p>
            ...
            <strong>
              ...
              de ikke dupliserer komponenter som allerede finnes i
              Designsystemet.
            </strong>
          </p>
        </div>
