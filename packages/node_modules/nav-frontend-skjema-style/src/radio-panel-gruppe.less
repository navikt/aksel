.radioPanelGruppe {
  .radioPanel {
    ...
    &--disabled {
      ...
      &:hover {
        border: 2px solid @navGra20 !important; // lesshint importantRule: false
        box-shadow: none !important; // lesshint importantRule: false
      }

      .skjemaelement__label:before {
        box-shadow: none !important; // lesshint importantRule: false
        background-color: @navLysGra !important; // lesshint importantRule: false
        border: 2px solid @navGra20 !important; // lesshint importantRule: false
      }
    }
    ...
    &--checked {
      ...
      .skjemaelement__label:before {
        border: 2px solid @navBla !important; // lesshint importantRule: false
        box-shadow: none !important; // lesshint importantRule: false
