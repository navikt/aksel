...
export class StegindikatorSteg extends React.Component<StegindikatorStegProps> {
...
class Stegindikator extends React.Component<StegindikatorProps, StegindikatorState> {
    ...
    componentWillReceiveProps(nextProps: StegindikatorProps) {
        ...
        if (this.props.children) {
            React.Children.forEach(this.props.children, (child, i) => {
                if (React.isValidElement(child)) {
                    ...
                    if (clone.props['defaultAktiv']) {
                        index = i;
                    }
                }
            });
        } else {
            index = this.props.steg.findIndex((steg) => !!steg.defaultAktiv);
        }
    ...
    renderSteg() {
            ...
            return React.Children.map(this.props.children, (child, i) => {
                if (React.isValidElement(child)) {
                    return React.cloneElement(child as React.ReactElement<any>, {
                        ...
                        aktiv: child.props['aktiv'] || i === this.state.aktivtSteg,
        ...
        return this.props.steg.map((steg, i) => {
            ...
            const aktiv = steg.aktiv || i === this.state.aktivtSteg;
