...
<Example>
    <Søkeknapp>Valgfri tekst</Søkeknapp>
</Example>
...
<Example>
    <Menyknapp>Valgfri tekst</Menyknapp>
</Example>
...
<Alertstripe type="info">
    Det er tenkt at denne omsider skal erstatte den gamle <a className="lenke" href="/components/lukknapp">lukknapp-komponenten</a>.
</Alertstripe>
