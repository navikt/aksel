...
<div className="navds-alert navds-alert--info navds-alert--medium">
  ...
  >
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
      d="M12 0C18.6274 0 24 5.37258 24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0ZM9 19V17H11V12H9V10H13V17H15V19H9ZM12 5C12.8284 5 13.5 5.67157 13.5 6.5C13.5 7.32843 12.8284 8 12 8C11.1716 8 10.5 7.32843 10.5 6.5C10.5 5.67157 11.1716 5 12 5Z"
      fill="currentColor"
    />
  </svg>
...
```html type=html
<div className="navds-alert navds-alert--info navds-alert--small">
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
