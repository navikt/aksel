# react-module: nav-frontend-veileder-panel

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-veileder-panel react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-veileder-panel
<!-- AUTO-GENERATED-CONTENT:END *-->