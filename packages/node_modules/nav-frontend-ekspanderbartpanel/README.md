...
### Installering:
```
npm install nav-frontend-ekspanderbartpanel classnames nav-frontend-chevron-style nav-frontend-core nav-frontend-ekspanderbartpanel-style nav-frontend-typografi nav-frontend-typografi-style prop-types react react-collapse --save
```
