...
export const ScrollTop = () => {
  ...
  return (
    <button
      ...
      className="text-xlarge text-text-inverted focus-visible:shadow-focus-inverted group -mt-[10px] flex h-[48px] w-fit items-center justify-center gap-2 p-2 font-semibold hover:underline focus:outline-none"
    >
      <svg
        fill="none"
