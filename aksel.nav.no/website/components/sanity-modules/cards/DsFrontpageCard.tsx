...
const Card = ({ node, tag, href, className, ...rest }: CardProps) => {
  return (
    <div
      className={cl(
        "text-text shadow-small hover:shadow-medium active:text-link group relative flex aspect-[21/22] w-[18rem] flex-col rounded bg-white p-6 pt-8 ring-1 ring-gray-900/10  focus-within:outline-none lg:aspect-[18/22] lg:p-8 lg:pt-12",
        className
      )}
    >
