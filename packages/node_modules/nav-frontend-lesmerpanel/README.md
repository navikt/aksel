...
### Installering:
```
npm install @types/react-collapse classnames lodash.throttle nav-frontend-chevron nav-frontend-chevron-style nav-frontend-core nav-frontend-js-utils nav-frontend-lesmerpanel nav-frontend-lesmerpanel-style nav-frontend-paneler-style prop-types react react-collapse --save
```
