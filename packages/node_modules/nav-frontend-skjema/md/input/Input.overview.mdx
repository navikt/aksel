...
<Alertstripe type="advarsel">
    Dette er foreløpig <strong>kun tillatt</strong> på inputfelter inne i tabell-rader eller lignende tilfeller hvor det er veldig vanskelig å ha en synlig tekst-label i nærheten av inputfeltet. <strong>Skal ikke misbrukes.</strong>
</Alertstripe>
...
<Alertstripe type="info">
    Les mer om hvorfor det kan være lurt å sende Hjelpetekst inn med <code className="inline">label</code>-propen på <Lenke href="/components/hjelpetekst/accessibility">komponentens tilgjengelighets-sider</Lenke>.
</Alertstripe>
