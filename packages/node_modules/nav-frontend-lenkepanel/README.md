...
### Installering:
```
npm install nav-frontend-lenkepanel babel-polyfill classnames nav-frontend-alertstriper-style nav-frontend-ikoner-assets nav-frontend-paneler-style nav-frontend-core nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
