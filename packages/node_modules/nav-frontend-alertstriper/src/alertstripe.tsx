...
const cls = (type, solid, className) => classNames('alertstripe', className, {
    ...
    'alertstripe--advarsel': type === 'advarsel' || type === 'stopp',
    'alertstripe--info': type === 'info' || type === 'nav-ansatt' || type === 'viktig',
    'alertstripe--suksess': type === 'suksess'
});
const ikonKind = (type, solid): icons => {
    const kindMap = {
        'feil-sirkel-fyll': type === 'advarsel' || type === 'stopp',
        'info-sirkel-fyll': type === 'info' || type === 'nav-ansatt' || type === 'viktig',
