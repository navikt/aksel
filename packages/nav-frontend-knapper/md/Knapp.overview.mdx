...
import {
  ...
  Do,
  Dont,
} from "../../../website/src/components/do-dont/DoDont";
...
I tidligere versjoner av knappen ble den satt til "uppercase" automatisk av stilen sin. Dette er nå
tatt en vurdering på å vi skal prøve at alle knappene på NAV tar i bruk "Sentence case". Det vil si at alle
knapper skal starte med "uppercase", mens resten av teksten skal være "lowercase".

<DoDont>
  <Do>
    <Knapp>Send søknad</Knapp>
  </Do>
  <Dont>
    <div className="dodont__button-example">
      <div>
        <Knapp>SEND SØKNAD</Knapp>
      </div>
      <div>
