...
### Installering:
```
npm install classnames nav-frontend-core nav-frontend-paneler-style nav-frontend-typografi-style nav-frontend-veileder nav-frontend-veileder-style nav-frontend-veilederpanel nav-frontend-veilederpanel-style prop-types react --save
```
