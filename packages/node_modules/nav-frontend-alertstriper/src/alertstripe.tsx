...
const cls = (type, solid, className) => classNames('alertstripe', className, {
    ...
    'alertstripe--stopp': type === AlertStripeType.stopp
});
...
const ikonKind = (type: AlertStripeType): icons => {
    const kindMap = {
        ...
        'feil-sirkel-fyll': type === AlertStripeType.stopp
    };
...
class AlertStripe extends React.Component<AlertStripeBaseProps> {
    render() {
        ...
        const ariaLive = (type === AlertStripeType.advarsel || type === AlertStripeType.stopp) ?
            'assertive' :
            undefined;
