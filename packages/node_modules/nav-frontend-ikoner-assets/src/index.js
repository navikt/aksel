...
export default class Icon extends Component {
  ...
  getIcon(kind) {
    ...
    switch (kind) {
      ...
      case ('feil-sirkel-fylt'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 24 24"><path fill="#BA3A26" d="M0 12c0 3.2 1.2 6.2 3.4 8.5S8.6 24 11.7 24c6.5 0 11.8-5.4 11.8-12S18.2 0 11.7 0C5.3 0 0 5.4 0 12zm11.8 11.5zm6.6-9.9H5.1v-3.1h13.3v3.1z"/></svg>);  
      case ('help-circle'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 18.22 18.22"><path fill="transparent" d="M9.11 1a8.11 8.11 0 1 0 8.11 8.11A8.12 8.12 0 0 0 9.11 1zm0 13.7a.89.89 0 1 1 .89-.9.89.89 0 0 1-.89.9zm.5-5.7v1.89a.5.5 0 0 1-1 0V8.5a.5.5 0 0 1 .5-.5 1.85 1.85 0 1 0-1.85-1.85.5.5 0 0 1-1 0A2.85 2.85 0 1 1 9.61 9z"/><path fill="#3e3832" d="M9.11 0a9.11 9.11 0 1 0 9.11 9.11A9.12 9.12 0 0 0 9.11 0zm0 17.22a8.11 8.11 0 1 1 8.11-8.11 8.12 8.12 0 0 1-8.11 8.11z"/><path fill="#3e3832" d="M9.11 3.3a2.85 2.85 0 0 0-2.85 2.85.5.5 0 0 0 1 0A1.85 1.85 0 1 1 9.11 8a.5.5 0 0 0-.5.5v2.35a.5.5 0 0 0 1 0V9a2.85 2.85 0 0 0 2.27-3.33A2.9 2.9 0 0 0 9.11 3.3z"/><circle fill="#3e3832" cx="9.11" cy="13.8" r=".89"/></svg>);
      case ('help-circle_hover'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 18.22 18.22"><path fill="#2868B3" d="M9.1 0C4.1 0 0 4.1 0 9.1s4.1 9.1 9.1 9.1 9.1-4.1 9.1-9.1S14.1 0 9.1 0zm0 14.7c-.5 0-.9-.4-.9-.9s.4-.9.9-.9.9.4.9.9-.4.9-.9.9zM9.6 9v1.9c0 .3-.2.5-.5.5s-.5-.2-.5-.5V8.5c0-.3.2-.5.5-.5 1 0 1.9-.8 1.9-1.8s-.8-1.9-1.9-1.9-1.8.8-1.8 1.8c0 .3-.2.5-.5.5s-.5-.2-.5-.5c0-1.6 1.3-2.9 2.8-2.9 1.4 0 2.5 1 2.8 2.4.3 1.6-.7 3.1-2.3 3.4z"/></svg>);
      case ('info-sirkel'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 23 23" ><title>Informasjon-ikon</title><g stroke="#3E3832" fill="none" fillRule="evenodd" strokeLinejoin="round"><path d="M22.5 11.5c0 6.075-4.926 11-11 11-6.076 0-11-4.925-11-11s4.924-11 11-11c6.074 0 11 4.925 11 11zm-14 7h6" strokeLinecap="round"/><path strokeLinecap="round" d="M9.5 9.5h2V18"/><path d="M11 5a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1z"/></g></svg>);
      case ('info-sirkel-fylt'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 24 24" ><title>7BED67DE-AEBF-4364-B605-EBAAB1A44974</title><path d="M12 0C5.382 0 0 5.382 0 12s5.382 12 12 12c6.617 0 12-5.382 12-12S18.617 0 12 0zm-.522 5.217a1.045 1.045 0 1 1-.002 2.09 1.045 1.045 0 0 1 .002-2.09zm3.652 14.61H8.87a.522.522 0 0 1 0-1.044h2.608v-8.348H9.913a.522.522 0 0 1 0-1.044H12c.287 0 .522.234.522.522v8.87h2.608a.523.523 0 0 1 0 1.043z" fill="#3E3832" fillRule="evenodd"/></svg>);
      case ('info-sirkel-orange'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 24 24" ><title>02B4E6D8-92CF-493A-BD4F-1E4D48BCD9FA</title><g fill="#D87F0A" fillRule="evenodd"><path d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0zm0 22.957C5.958 22.957 1.043 18.042 1.043 12 1.043 5.958 5.958 1.043 12 1.043c6.042 0 10.957 4.915 10.957 10.957 0 6.042-4.915 10.957-10.957 10.957z"/><path d="M15.13 18.783h-2.608v-8.87A.522.522 0 0 0 12 9.391H9.913a.522.522 0 0 0 0 1.044h1.565v8.348H8.87a.522.522 0 0 0 0 1.043h6.26a.522.522 0 0 0 0-1.043z"/><ellipse cx="11.478" cy="5.739" rx="1.043" ry="1.043"/></g></svg>);
      case ('ok-sirkel'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 24 24" ><title>3E6826BC-1604-422F-B122-ACB8E2B34006</title><g fill="#06893A" fillRule="evenodd"><path d="M10 16a.502.502 0 0 1-.354-.147l-2.5-2.5a.5.5 0 0 1 .707-.707l2.16 2.158 7.145-6.67a.502.502 0 0 1 .707.024.502.502 0 0 1-.024.707l-7.5 7a.5.5 0 0 1-.34.134z"/><path d="M12 24C5.383 24 0 18.617 0 12S5.383 0 12 0s12 5.383 12 12-5.383 12-12 12zm0-23C5.935 1 1 5.935 1 12s4.935 11 11 11 11-4.935 11-11S18.065 1 12 1z"/></g></svg>);
      case ('ok-sirkel-fylt'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 25 24" ><title>937B54AB-E3F0-4413-8155-0D0A06C5A955</title><path d="M12.77 0C6.208 0 .87 5.384.87 12s5.338 12 11.9 12 11.902-5.384 11.902-12S19.332 0 12.77 0zm5.298 8.866l-7.439 7a.495.495 0 0 1-.69-.012l-2.479-2.5a.503.503 0 0 1 0-.707.493.493 0 0 1 .702 0l2.14 2.158 7.088-6.67a.494.494 0 0 1 .702.023.504.504 0 0 1-.024.708z" fill="#3E3832" fillRule="evenodd"/></svg>);
      case ('spinner'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><circle xmlns="http://www.w3.org/2000/svg" cx="50" cy="50" r="40" stroke="#bdbab7" fill="none" strokeWidth="10"/><circle cx="50" cy="50" r="40" stroke="#7f756c" fill="none" strokeWidth="10" strokeDasharray="50 155" strokeLinecap="round"/></svg>);
      case ('spinner-negativ'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><circle xmlns="http://www.w3.org/2000/svg" cx="50" cy="50" r="40" stroke="#eee" fill="none" strokeWidth="10"/><circle cx="50" cy="50" r="40" stroke="#888" fill="none" strokeWidth="10" strokeDasharray="50 155" strokeLinecap="round"/></svg>);
      case ('spinner-stroke'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><circle xmlns="http://www.w3.org/2000/svg" cx="50" cy="50" r="40" stroke="#bdbab7" fill="none" strokeWidth="13"/><circle cx="50" cy="50" r="40" stroke="#7f756c" fill="none" strokeWidth="7" strokeDasharray="50 155" strokeLinecap="round"/></svg>);
      case ('spinner-stroke-negativ'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><circle xmlns="http://www.w3.org/2000/svg" cx="50" cy="50" r="40" stroke="#eee" fill="none" strokeWidth="13"/><circle cx="50" cy="50" r="40" stroke="#888" fill="none" strokeWidth="7" strokeDasharray="50 155" strokeLinecap="round"/></svg>);
      case ('sporsmal-sirkel'): return (<svg {...props} focusable="false" height={height || size} width={width || size} onClick={onClick} style={style} viewBox="0 0 23 23" ><title>Spørsmålsikon</title><g stroke="#3E3832" fill="none" fillRule="evenodd" strokeLinejoin="round"><path d="M22.5 11.5c0 6.075-4.925 11-11 11s-11-4.925-11-11 4.925-11 11-11 11 4.925 11 11z" strokeLinecap="round"/><path d="M8.5 9a3 3 0 1 1 3 3v3" strokeLinecap="round"/><path d="M12 17.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"/></g></svg>);
