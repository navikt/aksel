---
ingress: Lenkepanel er klikkbare paneler, og kan brukes til lenker med høy prioritet. For eksempel sider som har hovedinnganger til forskjellige seksjoner.
---

import Lenkepanel, { LenkepanelBase } from "./../";
  ...
  <LenkepanelBase href="#" style={{ padding: "2rem 2.5rem 2rem 2rem" }} border>
    <div style={{ display: "flex", alignItems: "center" }}>
      ...
      <div>
        ...
        <p>
          Dagpenger er en delvis erstatning for tap av arbeidsinntekt som følge
          av arbeidsløshet.
        </p>
      </div>
    </div>
...
<LenkepanelBase href="#" border>
  <div>
    ...
    <div>
      <Systemtittel className="lenkepanel__heading">Dagpenger</Systemtittel>
      <p>
        Dagpenger er en delvis erstatning for tap av arbeidsinntekt som følge av
        arbeidsløshet.
      </p>
    </div>
  </div>
