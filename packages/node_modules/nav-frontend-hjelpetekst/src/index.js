    ...
    renderContent() {
        return (
            <span className={cls(this.props.type, classNames)}>{this.props.children}
                <button className="hjelpetekst__lukkeknapp" onClick={this.toggleSynlighet}>
    ...
    render() {
        ...
        return (
            <div className="hjelpetekst__container">
                <button className="hjelpetekst__apneknapp" onClick={this.toggleSynlighet} title={this.props.tittel} aria-pressed={this.state.erSynlig}>
