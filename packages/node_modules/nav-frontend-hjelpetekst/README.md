...
### Installering:
```
npm install classnames lodash.throttle nav-frontend-core nav-frontend-hjelpetekst nav-frontend-hjelpetekst-style nav-frontend-ikoner-assets nav-frontend-js-utils nav-frontend-popover nav-frontend-popover-style nav-frontend-typografi-style prop-types react --save
```
