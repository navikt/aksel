...
const cls = (bla, hvit, hjorne, className) => classNames('lenke', className);
...
const Lenke = ({ href, target, ariaLabel, children, className }) => (
    <a
        href={href}
        target={target}
...
Lenke.propTypes = {
    ...
    children: PT.oneOf(PT.node, PT.string).isRequired,
    target: PT.string,
    ariaLabel: PT.string,
    className: PT.string
};
