...
const content = 'Den klare luft, høylukten, blomsterduften, gangen, fuglekvitteret og de friske, luftningene ved elven, virket i høy grad opplivende på mitt sinn.';

export default generateSample({
    baseType: VeilederPanel,
    attrs: {
        svg: <Aleksander />,
        color: '#99bdcd'
    },
    children: content,
    modifierNames: ['compact']
});
