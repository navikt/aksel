# react-module: nav-frontend-tabs
...
```
npm install classnames lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-tabs nav-frontend-tabs-style nav-frontend-typografi-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-tabs
