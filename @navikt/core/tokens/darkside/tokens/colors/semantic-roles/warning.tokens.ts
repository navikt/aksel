...
export const warningSemanticTokenConfig = {
  bg: {
    ...
    "warning-moderate": {
      ...
      type: "color",
      group: "background.warning",
      comment: "En medium-svak bakgrunnsfarge som brukes til dekor. Om den brukes på meningsbærende elementer må den kombineres med en godkjent border (f.eks. alert warning).",
    },
    "warning-moderateA": {
  ...
  text: {
    warning: {
      ...
      type: "color",
      group: "text.warning",
      comment: "Sterk farge for tekst og ikoner for rollen warning. Godkjent på alle bakgrunner unntatt strong.",
    },
    "warning-subtle": {
      value: "{ax.warning.800.value}",
      type: "color",
      group: "text.warning",
      comment: "Standard farge for tekst og ikoner med rollen warning. Godkjent på alle bakgrunner unntatt strong.",
    },
    "warning-icon": {
      value: "{ax.warning.600.value}",
      type: "color",
