              ...
              <a
                ...
                className={cl(
                  "algolia-index-heading 2lg:px-4 min-w-header flex cursor-pointer items-center justify-center whitespace-nowrap py-0 px-2 focus:outline-none",
                  {
                    ...
                    "algolia-index-heading--active text-text bg-white  hover:bg-gray-50 focus-visible:shadow-[inset_0_0_0_1px_var(--navds-global-color-gray-900),inset_0_0_0_2px_var(--navds-global-color-white)_,inset_0_0_0_4px_var(--navds-global-color-gray-900)]":
                      pageProps?.activeHeading?.title === heading.title,
                  }
                )}
              >
