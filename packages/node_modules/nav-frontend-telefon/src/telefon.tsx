...
class NavFrontendTelefon extends React.Component<Props, State> {
    dropdownRef: any;
    numberInputRef: any;
    ...
    constructor(props: Props) {
        ...
        if (inputNumber.length > 1) {
            ...
            // Default country
            countryGuess =
                onlyCountries.find(o => o.iso2 == props.defaultCountry) || 0;
        } else {
            // Empty params
            countryGuess = 0;
        }
    ...
    insertMasks = (masks, filteredCountries) => {
        for (let key in masks) {
            const modifiedCountryIndex = filteredCountries.findIndex(
                o => o.iso2 == key
            );
    ...
    getCountryDropdownList = () => {
        ...
        return (
            <div style={this.props.dropdownStyle} className={dropDownClasses}>
                {enableSearchField && (
                    <div
                ...
                <div tabIndex={1} className="country-list">
                    <ul ref={el => (this.dropdownRef = el)}>
    ...
    render() {
        console.log(this.state.highlightCountryIndex);
        ...
        const inputFlagClasses = `flag ${selectedCountry &&
...
export default NavFrontendTelefon;
