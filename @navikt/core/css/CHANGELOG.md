...
- InlineMessage: Now uses BodyLong instead of BodyShort. Icon has some small adjustments to aligne with new typo. ([#4683](https://github.com/navikt/aksel/pull/4683))
