...
const informationHierarchyData = [
    { component: Sidetittel, content: 'Sidetittel' },
    {
        component: Ingress,
        content:
            `Ingress. Da nå skrubben hadde ett opp hesten, tok Askeladden bikselet og bandt i kjeften på den, 
    ...
    { component: Element, content: 'Element' },
    {
        ...
        content:
            `Normal. Fisken den tar av," sa han, med en stemme som trengte igjennom sagduren; "for slik en gullhake, 
