# react-module: nav-frontend-grid
...
```
npm install classnames nav-frontend-core nav-frontend-grid nav-frontend-grid-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-grid
