# react-module: nav-frontend-ikonknapper
...
```
npm install classnames lodash.throttle nav-frontend-chevron nav-frontend-chevron-style nav-frontend-core nav-frontend-ikoner-assets nav-frontend-ikonknapper nav-frontend-js-utils nav-frontend-knapper nav-frontend-knapper-style nav-frontend-typografi-style prop-types react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-ikonknapper
