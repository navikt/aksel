...
### Installering:
```
npm install lodash.throttle nav-frontend-core nav-frontend-js-utils nav-frontend-tabs nav-frontend-tabs-style nav-frontend-typografi-style prop-types react --save
```
