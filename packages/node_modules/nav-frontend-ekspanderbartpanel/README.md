...
### Installering:
```
npm install @nkbt/react-collapse classnames nav-frontend-chevron-style nav-frontend-core nav-frontend-ekspanderbartpanel nav-frontend-ekspanderbartpanel-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
