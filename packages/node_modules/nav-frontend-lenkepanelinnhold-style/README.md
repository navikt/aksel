# less-module: nav-frontend-lenkepanelinnhold-style

### Installering:
```
npm install nav-frontend-lenkepanelinnhold-style
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-lenkepanelinnhold-style
