...
Dersom du har mer enn fem alternativer, kan du vurdere om det er mer hensiktsmessig 
å benytte en [select](/components/select) i stedet.

<Example>
    <Fieldset legend="Hvor vil du sitte?">
