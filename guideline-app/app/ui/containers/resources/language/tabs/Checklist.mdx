# Sjekkliste for deg som skriver tekster
...
- Bruk ord som leseren vanligvis bruker, da er det enklere å finne om noen søker etter teksten din på i Google eller på selve nettsiden.
