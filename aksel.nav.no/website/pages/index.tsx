...
const AkselCube = () => (
  <div className="absolute -top-[19.5%] -left-[41%] right-0 z-0 scale-125 ">
    <svg
      viewBox="0 0 2514 2509"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="aksel-cube z-0"
    >
      <path
...
const Forside = ({ tekster, temaer, bloggs }: PageProps): JSX.Element => {
  ...
  return (
    <>
      ...
      <div className="aksel-cube-wrapper relative bg-[#DCCAF3]">
        <Header variant="transparent" />

        <main tabIndex={-1} id="hovedinnhold" className=" focus:outline-none">
          <div className="min-h-screen-header z-20 pb-8">
