...
// Variable: KOMPONENTOVERSIKT_QUERY
// Query: *[_type == "komponent_artikkel" && defined(kategori)]{_id,heading,"slug": slug.current,status,kategori, "sidebarindex": sidebarindex}
export type KOMPONENTOVERSIKT_QUERYResult = Array<{
  _id: string;
  heading: string | null;
  slug: string | null;
  status: {
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '*[_type == "komponent_artikkel" && defined(kategori)]{_id,heading,"slug": slug.current,status,kategori, "sidebarindex": sidebarindex}': KOMPONENTOVERSIKT_QUERYResult;
