...
export const rawAllCountries = [
    ...
    ['Algerie', ['africa', 'north-africa'], 'dz', '213'],
    ['Amerikansk Samoa', ['oceania'], 'as', '1684'],
    ['Andorra', ['europe'], 'ad', '376'],
    ['Angola', ['africa'], 'ao', '244'],
    ['Anguilla', ['america', 'carribean'], 'ai', '1264'],
    ['Antigua og Barbuda', ['america', 'carribean'], 'ag', '1268'],
    [
        'Argentina',
    ...
    ['Østerrike', ['europe', 'european-union'], 'at', '43'],
    ['Aserbajdsjan', ['asia', 'ex-ussr'], 'az', '994'],
    ['Bahamas', ['america', 'carribean'], 'bs', '1242'],
    ['Bahrain', ['middle-east'], 'bh', '973'],
    ['Bangladesh', ['asia'], 'bd', '880'],
    ['Barbados', ['america', 'carribean'], 'bb', '1246'],
    ['Hviterussland', ['europe', 'ex-ussr'], 'by', '375', '+... (..) ... .. ..'],
    ['Belgia', ['europe', 'european-union'], 'be', '32', '+.. ... .. .. ..'],
    ['Belize', ['america', 'central-america'], 'bz', '501'],
    ['Benin', ['africa'], 'bj', '229'],
    ['Bermuda', ['america', 'north-america'], 'bm', '1441'],
    ['Bhutan', ['asia'], 'bt', '975'],
    ['Bolivia', ['america', 'south-america'], 'bo', '591'],
    ['Bosnia-Hercegovina', ['europe'], 'ba', '387'],
    ['Botswana', ['africa'], 'bw', '267'],
    ['Brasil', ['america', 'south-america'], 'br', '55', '+.. (..) .........'],
    ['Det britiske territoriet i Indiahavet', ['asia'], 'io', '246'],
    ['De britiske jomfruøyer', ['america', 'carribean'], 'vg', '1284'],
    ['Brunei', ['asia'], 'bn', '673'],
    ['Bulgaria', ['europe', 'european-union'], 'bg', '359'],
    ['Burkina Faso', ['africa'], 'bf', '226'],
    ['Burundi', ['africa'], 'bi', '257'],
    ['Kambodsja', ['asia'], 'kh', '855'],
    ['Kamerun', ['africa'], 'cm', '237'],
    [
        'Canada',
    ...
    ['Kapp Verde', ['africa'], 'cv', '238'],
    ['De nederlandske Antiller', ['america', 'carribean'], 'bq', '599', '', 1],
    ['Caymanøyene', ['america', 'carribean'], 'ky', '1345'],
    ['Den sentralafrikanske republikk', ['africa'], 'cf', '236'],
    ['Tsjad', ['africa'], 'td', '235'],
    ['Chile', ['america', 'south-america'], 'cl', '56'],
    ['Kina', ['asia'], 'cn', '86', '+.. ..-.........'],
    ['Colombia', ['america', 'south-america'], 'co', '57'],
    ['Komorene', ['africa'], 'km', '269'],
    ['Den demokratiske republikken Kongo', ['africa'], 'cd', '243'],
    ['Kongo', ['africa'], 'cg', '242'],
    ['Cookøyene', ['oceania'], 'ck', '682'],
    [
        'Costa Rica',
    ...
    ['Elfenbenskysten', ['africa'], 'ci', '225'],
    ['Kroatia', ['europe', 'european-union'], 'hr', '385'],
    ['Cuba', ['america', 'carribean'], 'cu', '53'],
    ['Curaçao', ['america', 'carribean'], 'cw', '599', '', 0],
    ['Kypros', ['europe', 'european-union'], 'cy', '357', '+... .. ......'],
    ['Tsjekkia', ['europe', 'european-union'], 'cz', '420'],
    ['Danmark', ['europe', 'european-union'], 'dk', '45', '+.. .. .. .. ..'],
    ['Djibouti', ['africa'], 'dj', '253'],
    ['Den dominikanske republikk', ['america', 'carribean'], 'dm', '1767'],
    [
    ...
    ['Ekvatorial-Guinea', ['africa'], 'gq', '240'],
    ...
    ['Etiopia', ['africa'], 'et', '251'],
    ['Falklandøyene', ['america', 'south-america'], 'fk', '500'],
    ['Færyøyene', ['europe'], 'fo', '298'],
    ['Fiji', ['oceania'], 'fj', '679'],
    ['Finland', ['europe', 'european-union'], 'fi', '358', '+... .. ... .. ..'],
    ['Frankrike', ['europe', 'european-union'], 'fr', '33', '+.. . .. .. .. ..'],
    ['Fransk Guyana', ['america', 'south-america'], 'gf', '594'],
    ['Fransk Polynesia', ['oceania'], 'pf', '689'],
    ['Gabon', ['africa'], 'ga', '241'],
    ['Gambia', ['africa'], 'gm', '220'],
    ['Georgia', ['asia', 'ex-ussr'], 'ge', '995'],
    ['Tyskland', ['europe', 'european-union'], 'de', '49', '+.. .... ........'],
    ['Ghana', ['africa'], 'gh', '233'],
    ['Gibraltar', ['europe'], 'gi', '350'],
    ['Hellas', ['europe', 'european-union'], 'gr', '30'],
    ['Grønland', ['america'], 'gl', '299'],
    ...
    ['Ungarn', ['europe', 'european-union'], 'hu', '36'],
    ['Island', ['europe'], 'is', '354', '+... ... ....'],
    ['India', ['asia'], 'in', '91', '+.. .....-.....'],
    ['Indonesia', ['asia'], 'id', '62'],
    ['Iran', ['middle-east'], 'ir', '98'],
    ['Irak', ['middle-east'], 'iq', '964'],
    ['Irland', ['europe', 'european-union'], 'ie', '353', '+... .. .......'],
    ['Israel', ['middle-east'], 'il', '972', '+... ... ... ....'],
    ['Italia', ['europe', 'european-union'], 'it', '39', '+.. ... .......', 0],
    ...
    ['Marokko', ['africa', 'north-africa'], 'ma', '212'],
    ...
    ['Saint Kitts og Nevis', ['america', 'carribean'], 'kn', '1869'],
    ['Saint Lucia', ['america', 'carribean'], 'lc', '1758'],
    ['Saint Martin', ['america', 'carribean'], 'mf', '590', '', 2],
    ['Saint Pierre og Miquelon', ['america', 'north-america'], 'pm', '508'],
    [
    ...
    ['Solomonøyene', ['oceania'], 'sb', '677'],
    ['Somalia', ['africa'], 'so', '252'],
    ['Sør-Afrika', ['africa'], 'za', '27'],
    ['Sør-Korea', ['asia'], 'kr', '82', '+.. ... .... ....'],
    ['Sør-Sudan', ['africa', 'north-africa'], 'ss', '211'],
    ['Spania', ['europe', 'european-union'], 'es', '34', '+.. ... ... ...'],
    ['Sri Lanka', ['asia'], 'lk', '94'],
    ['Sudan', ['africa'], 'sd', '249'],
    ['Surinam', ['america', 'south-america'], 'sr', '597'],
    ['Swaziland', ['africa'], 'sz', '268'],
    ['Sverige', ['europe', 'european-union'], 'se', '46', '+.. (...) ...-...'],
    ['Sveits', ['europe'], 'ch', '41', '+.. .. ... .. ..'],
    ['Syria', ['middle-east'], 'sy', '963'],
    ['Taiwan', ['asia'], 'tw', '886'],
    ['Tadsjikistan', ['asia', 'ex-ussr'], 'tj', '992'],
    ['Tanzania', ['africa'], 'tz', '255'],
    ['Thailand', ['asia'], 'th', '66'],
    ['Øst-Timor', ['asia'], 'tl', '670'],
    ['Togo', ['africa'], 'tg', '228'],
    ['Tokelau', ['oceania'], 'tk', '690'],
    ['Tonga', ['oceania'], 'to', '676'],
    ['Trinidad og Tobago', ['america', 'carribean'], 'tt', '1868'],
    ['Tunisia', ['africa', 'north-africa'], 'tn', '216'],
    ['Tyrkia', ['europe'], 'tr', '90', '+.. ... ... .. ..'],
    ['Turkmenistan', ['asia', 'ex-ussr'], 'tm', '993'],
    ['Turks og Caicos-øyene', ['america', 'carribean'], 'tc', '1649'],
    ['Tuvalu', ['asia'], 'tv', '688'],
    ['De amerikanske Jomfruøyer', ['america', 'carribean'], 'vi', '1340'],
    ['Uganda', ['africa'], 'ug', '256'],
    ['Ukraina', ['europe', 'ex-ussr'], 'ua', '380', '+... (..) ... .. ..'],
    ['De forente arabiske emirater', ['middle-east'], 'ae', '971'],
    [
        'Storbritannia',
        ['europe', 'european-union'],
        'gb',
    ...
    ['Usbekistan', ['asia', 'ex-ussr'], 'uz', '998'],
    ['Vanuatu', ['oceania'], 'vu', '678'],
    ['Vatikanstaten', ['europe'], 'va', '39', '+.. .. .... ....', 1],
    ['Venezuela', ['america', 'south-america'], 've', '58'],
    ['Vietnam', ['asia'], 'vn', '84'],

    ['Wallis og Futuna', ['oceania'], 'wf', '681'],
