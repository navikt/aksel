...
While some of these points are important, we are open to all teams wanting to test the new implementation.
But be aware that there might be breaking changes as we go, and we won't have all tooling ready for adoption yet.
