...
import {
    SkjemaGruppe, SkjemaGruppeFeilContext, SkjemaGruppeFeilContextProps, SkjemaelementFeilmelding
} from '.';
...
export class RadioPanel extends React.Component<RadioPanelProps, RadioPanelState> {
    ...
    render() {
        const {
            id, label, checked, disabled, ...other
        } = this.props;
...
class RadioPanelGruppe extends React.Component<RadioPanelGruppeProps> {
    render() {
        const {
            radios, name, legend, feil, checked, onChange, className, ...other
        } = this.props;
