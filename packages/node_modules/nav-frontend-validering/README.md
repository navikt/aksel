# react-module: nav-frontend-validering

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-validering react --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-validering
<!-- AUTO-GENERATED-CONTENT:END *-->