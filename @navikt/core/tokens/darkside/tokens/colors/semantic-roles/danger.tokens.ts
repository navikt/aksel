...
export const dangerSemanticTokenConfig = {
  bg: {
    ...
    "danger-moderate": {
      ...
      type: "color",
      group: "background.danger",
      comment: "En medium-svak bakgrunnsfarge som brukes til dekor. Om den brukes på meningsbærende elementer må den kombineres med en godkjent border (f.eks. alert error).",
    },
    "danger-moderateA": {
    ...
    "danger-strong": {
      ...
      type: "color",
      group: "background.danger",
      comment: "En sterk bakgrunnsfarge som brukes på meningsbærende elementer (f.eks. button danger primary).",
    },
    "danger-strong-hover": {
      value: "{ax.danger.700.value}",
      type: "color",
      group: "background.danger",
      comment: "En sterk bakgrunnsfarge som brukes til hover-state på meningsbærende elementer (f.eks. button danger primary hover).",
    },
    "danger-strong-pressed": {
      value: "{ax.danger.800.value}",
      type: "color",
      group: "background.danger",
      comment: "En sterk bakgrunnsfarge som brukes til active/selected-state på meningsbærende elementer (f.eks. button danger primary active).",
    },
  },
  text: {
    danger: {
      ...
      type: "color",
      group: "text.danger",
      comment: "Sterk farge for tekst og ikoner for rollen danger. Godkjent på alle bakgrunner unntatt strong.",
    },
    "danger-subtle": {
      value: "{ax.danger.800.value}",
      type: "color",
      group: "text.danger",
      comment: "Standard farge for tekst og ikoner med rollen danger. Godkjent på alle bakgrunner unntatt strong.",
    },
    "danger-icon": {
      value: "{ax.danger.600.value}",
      type: "color",
    ...
    "danger-contrast": {
      ...
      type: "color",
      group: "text.danger",
      comment: "En farge som brukes på tekst og ikoner som plasseres oppå bakgrunnen strong (f.eks. button danger primary).",
    },
  },
  border: {
    danger: {
