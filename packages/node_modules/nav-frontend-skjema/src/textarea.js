...
class Textarea extends Component {
    ...
    componentDidMount() {
        ...
        window.requestAnimationFrame(() => {
            this.tekstomrade && (this.tekstomrade.style.height = `${Math.max(this.tekstomrade.scrollHeight, 30) + 30}px`);
        });
    }
    ...
    render() {
        const { label, maxLength, textareaClass, id, name, ...other } = this.props;
