...
### Installering:
```
npm install babel-polyfill classnames nav-frontend-chevron-style nav-frontend-core nav-frontend-lenkepanel nav-frontend-lenkepanel-style nav-frontend-paneler-style nav-frontend-typografi nav-frontend-typografi-style prop-types react --save
```
