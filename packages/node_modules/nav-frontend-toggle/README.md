...
### Installering:
```
npm install nav-frontend-toggle react nav-frontend-js-utils lodash.throttle prop-types nav-frontend-toggle-style nav-frontend-core nav-frontend-typografi-style nav-frontend-knapper-style --save
```
