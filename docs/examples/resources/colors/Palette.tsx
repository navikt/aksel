...
const Palette = () => {
  ...
  return (
    <React.Fragment>
      ...
      <section className="section">
        <Undertittel id="hovedfarger">Hovedfarger</Undertittel>
        <Normaltekst>
      ...
      <section className="section">
        <Undertittel id="bakgrunnsFarger">Bakgrunnsfarger</Undertittel>
      ...
      <section className="section">
        <Undertittel id="systemfarger">Systemfarger</Undertittel>
        <Alertstripe type="info">
      ...
      <section className="section full">
        <Undertittel id="hele-paletten">Hele paletten</Undertittel>
