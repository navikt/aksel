...
export const ColorRole: Story = {
  render: () => (
    <VStack gap="2">
      ...
      <Label data-color-role="brand-magenta">{lorem}</Label>
      <Label data-color-role="brand-magenta" textColor="default">
        {lorem}
      </Label>
      <Label data-color-role="brand-magenta" textColor="subtle">
        {lorem}
      </Label>
    </VStack>
  ),
